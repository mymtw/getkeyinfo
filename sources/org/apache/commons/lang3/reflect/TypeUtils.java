...
public class TypeUtils {
        ...
        if (cls2.isInterface()) {
            ...
            for (Type type2 : cls.getGenericInterfaces()) {
                if (type2 instanceof ParameterizedType) {
                    ...
                    throw new IllegalStateException(C0073e.m207g("Unexpected generic interface type found: ", type2));
                }
    ...
    private static Class<?> getRawType(ParameterizedType parameterizedType) {
        ...
        throw new IllegalStateException(C0073e.m207g("Wait... What!? Type of rawType: ", rawType));
    }
    ...
    private static Type substituteTypeVariables(Type type, Map<TypeVariable<?>, Type> map) {
        ...
        throw new IllegalArgumentException(C0073e.m207g("missing assignment type for type variable ", type));
    }
    ...
    private static boolean isAssignable(Type type, Type type2, Map<TypeVariable<?>, Type> map) {
        ...
        throw new IllegalStateException(C0073e.m207g("found an unhandled type: ", type2));
    }
    ...
    private static Map<TypeVariable<?>, Type> getTypeArguments(Type type, Class<?> cls, Map<TypeVariable<?>, Type> map) {
        ...
        if (type instanceof WildcardType) {
            ...
            throw new IllegalStateException(C0073e.m207g("found an unhandled type: ", type));
        }
    }
    ...
    public static Class<?> getRawType(Type type, Type type2) {
        ...
        if (type instanceof TypeVariable) {
            ...
            throw new IllegalArgumentException(C0073e.m207g("unknown type: ", type));
        }
    }
