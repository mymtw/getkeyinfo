...
public final class C8349a {
    /* renamed from: a */
    public static ColorFilter m16658a(BlendModeCompat blendModeCompat) {
        PorterDuff.Mode mode;
        BlendMode blendMode;
        if (Build.VERSION.SDK_INT >= 29) {
            switch (C8350b.f18317a[blendModeCompat.ordinal()]) {
                case 1:
            ...
            if (blendMode != null) {
                return new BlendModeColorFilter(0, blendMode);
            }
            return null;
        }
