...
/* renamed from: s6.h0 */
public final class C7848h0 extends C7686e.C7688b {
    public C7848h0(C7676c cVar, C7681d dVar, C7681d dVar2, boolean z) {
    ...
    public C7848h0(C7676c cVar, C7681d dVar, C7681d dVar2, C7681d[] dVarArr, boolean z) {
    ...
    public final C7686e mo20131j(C7686e eVar) {
        ...
        if (dVar8.mo20109r()) {
            ...
            if (dVar5.mo20109r()) {
                return new C7848h0(cVar, dVar5, cVar.f17025c.mo20106o(), this.f17052e);
            }
            ...
            if (j3.mo20109r()) {
                return new C7848h0(cVar, j3, cVar.f17025c.mo20106o(), this.f17052e);
            }
        ...
        return new C7848h0(cVar, dVar5, dVar4, new C7681d[]{dVar6}, this.f17052e);
    }
    ...
    public final C7686e mo20134m(C7686e eVar) {
        ...
        if (h.mo20109r()) {
            return new C7848h0(cVar, h, cVar.f17025c.mo20106o(), this.f17052e);
        }
        C7681d j2 = h.mo20104m().mo20101j(j);
        C7681d j3 = h.mo20101j(m4).mo20101j(m3);
        return new C7848h0(cVar, j2, h.mo20094c(m4).mo20104m().mo20099h(c, dVar5.mo20100i(), j3), new C7681d[]{j3}, this.f17052e);
    }

    /* renamed from: n */
    public final C7686e mo20135n() {
        mo20139r();
        return new C7848h0((C7676c) null, this.f17049b, mo20137p(), false);
    }
    ...
    public final C7686e mo20144v() {
        ...
        return new C7848h0(cVar, dVar, dVar2.mo20094c(dVar3), dVarArr, this.f17052e);
    }
    ...
    public final C7686e mo20145w() {
        ...
        C7681d p = C13983i.m21497p(dVar2, j, m);
        if (p.mo20109r()) {
            return new C7848h0(cVar, p, cVar.f17025c.mo20106o(), this.f17052e);
        }
        ...
        return new C7848h0(cVar, m2, dVar.mo20095d(p, j).mo20094c(m2).mo20094c(j2), new C7681d[]{j2}, this.f17052e);
    }
}
