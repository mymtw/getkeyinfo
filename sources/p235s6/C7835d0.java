...
/* renamed from: s6.d0 */
public final class C7835d0 extends C7686e.C7688b {
    public C7835d0(C7676c cVar, C7681d dVar, C7681d dVar2, boolean z) {
    ...
    public C7835d0(C7676c cVar, C7681d dVar, C7681d dVar2, C7681d[] dVarArr, boolean z) {
    ...
    public final C7686e mo20131j(C7686e eVar) {
        ...
        if (dVar8.mo20109r()) {
            ...
            dVar5 = l.mo20104m().mo20094c(l).mo20094c(dVar12).mo20100i();
            if (dVar5.mo20109r()) {
                return new C7835d0(cVar, dVar5, cVar.f17025c, this.f17052e);
            }
            ...
            if (j3.mo20109r()) {
                return new C7835d0(cVar, j3, cVar.f17025c, this.f17052e);
            }
        ...
        return new C7835d0(cVar, dVar5, dVar4, new C7681d[]{dVar6}, this.f17052e);
    }
    ...
    public final C7686e mo20134m(C7686e eVar) {
        ...
        C7681d c = m3.mo20094c(m2).mo20094c(dVar3.mo20101j(dVar4));
        C7681d h = dVar5.mo20101j(m3).mo20094c(m2).mo20099h(c, m, m3);
        ...
        if (h.mo20109r()) {
            return new C7835d0(cVar, h, cVar.f17025c, this.f17052e);
        }
        C7681d j2 = h.mo20104m().mo20101j(j);
        C7681d j3 = h.mo20101j(m4).mo20101j(m3);
        return new C7835d0(cVar, j2, h.mo20094c(m4).mo20104m().mo20099h(c, dVar5.mo20100i(), j3), new C7681d[]{j3}, this.f17052e);
    }

    /* renamed from: n */
    public final C7686e mo20135n() {
        mo20139r();
        return new C7835d0((C7676c) null, this.f17049b, mo20137p(), false);
    }
    ...
    public final C7686e mo20144v() {
        ...
        return new C7835d0(cVar, dVar, dVar2.mo20094c(dVar3), dVarArr, this.f17052e);
    }
    ...
    public final C7686e mo20145w() {
        ...
        if (!q) {
            dVar3 = dVar3.mo20104m();
        }
        C7681d p = C13983i.m21497p(dVar2, j, dVar3);
        if (p.mo20109r()) {
            return new C7835d0(cVar, p, cVar.f17025c, this.f17052e);
        }
        C7681d m = p.mo20104m();
        C7681d j2 = q ? p : p.mo20101j(dVar3);
        C7681d m2 = dVar2.mo20094c(dVar).mo20104m();
        return new C7835d0(cVar, m, m2.mo20094c(p).mo20094c(dVar3).mo20101j(m2).mo20094c(m), new C7681d[]{j2}, this.f17052e);
    }
}
