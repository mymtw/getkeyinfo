...
/* renamed from: s6.u1 */
public final class C7888u1 extends C7686e.C7689c {
    public C7888u1(C7676c cVar, C7681d dVar, C7681d dVar2, boolean z) {
    ...
    public C7888u1(C7676c cVar, C7681d dVar, C7681d dVar2, C7681d[] dVarArr, boolean z) {
    ...
    public final p209p6.C7686e mo20131j(p209p6.C7686e r17) {
        ...
        L_0x010b:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p235s6.C7888u1.mo20131j(p6.e):p6.e");
    }
    ...
    public final C7686e mo20135n() {
        mo20139r();
        return new C7888u1((C7676c) null, this.f17049b, mo20137p(), false);
    }

    /* renamed from: v */
    public final C7686e mo20144v() {
        return mo20141t() ? this : new C7888u1(this.f17048a, this.f17049b, this.f17050c.mo20102k(), this.f17051d, this.f17052e);
    }
    ...
    public final C7686e mo20145w() {
        ...
        int[] iArr2 = new int[5];
        int[] iArr3 = new int[5];
        C0114h.m291V(t1Var.f17346f, iArr3);
        int[] iArr4 = new int[5];
        C0114h.m291V(iArr3, iArr4);
        boolean q = t1Var3.mo20108q();
        int[] iArr5 = t1Var3.f17346f;
        if (!q) {
            C0114h.m291V(iArr5, iArr2);
            iArr5 = iArr2;
        }
        C0114h.m292W(t1Var2.f17346f, iArr5, iArr);
        if (C3039b.m7166h(t1Var2.f17346f, iArr5, iArr2) != 0 || (iArr2[4] == -1 && C3039b.m7147Q(iArr2, C0114h.f183t))) {
            C2606m.m6143i(5, 21389, iArr2);
        }
        C0114h.m271C(iArr2, iArr, iArr2);
        C0114h.m327x(C3039b.m7141J(iArr2, iArr2, iArr2), iArr2);
        C0114h.m271C(iArr3, t1Var2.f17346f, iArr3);
        C0114h.m327x(C2606m.m6114I(5, iArr3), iArr3);
        C0114h.m327x(C2606m.m6156v(5, iArr4, iArr), iArr);
        C7885t1 t1Var4 = new C7885t1(iArr4);
        C0114h.m291V(iArr2, iArr4);
        int[] iArr6 = t1Var4.f17346f;
        C0114h.m292W(iArr6, iArr3, iArr6);
        int[] iArr7 = t1Var4.f17346f;
        C0114h.m292W(iArr7, iArr3, iArr7);
        C7885t1 t1Var5 = new C7885t1(iArr3);
        C0114h.m292W(iArr3, t1Var4.f17346f, iArr3);
        int[] iArr8 = t1Var5.f17346f;
        C0114h.m271C(iArr8, iArr2, iArr8);
        int[] iArr9 = t1Var5.f17346f;
        C0114h.m292W(iArr9, iArr, iArr9);
        C7885t1 t1Var6 = new C7885t1(iArr2);
        if (C2606m.m6154t(5, 0, t1Var.f17346f, iArr2) != 0 || (iArr2[4] == -1 && C3039b.m7147Q(iArr2, C0114h.f183t))) {
            C2606m.m6143i(5, 21389, iArr2);
        }
        if (!q) {
            int[] iArr10 = t1Var6.f17346f;
            C0114h.m271C(iArr10, t1Var3.f17346f, iArr10);
        }
        return new C7888u1(cVar, t1Var4, t1Var5, new C7681d[]{t1Var6}, this.f17052e);
    }
