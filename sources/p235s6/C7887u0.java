...
/* renamed from: s6.u0 */
public final class C7887u0 extends C7676c.C7677a {

    /* renamed from: j */
    public C7890v0 f17347j = new C7890v0(this, (C7681d) null, (C7681d) null, false);

    public C7887u0() {
        super(239, 158, 0, 0);
        this.f17024b = new C7884t0(BigInteger.valueOf(0));
        this.f17025c = new C7884t0(BigInteger.valueOf(1));
        this.f17026d = new BigInteger(1, C8260c.m16545a("2000000000000000000000000000005A79FEC67CB6E91F1C1DA800E478A5"));
        this.f17027e = BigInteger.valueOf(4);
        this.f17028f = 6;
    }
