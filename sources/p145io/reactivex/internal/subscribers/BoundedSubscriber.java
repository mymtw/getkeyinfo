...
public final class BoundedSubscriber<T> extends AtomicReference<Subscription> implements C8056i<T>, Subscription, Disposable {
    ...
    public BoundedSubscriber(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, C8333a aVar, Consumer<? super Subscription> consumer3, int i) {
