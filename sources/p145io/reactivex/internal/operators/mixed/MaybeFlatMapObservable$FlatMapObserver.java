...
final class MaybeFlatMapObservable$FlatMapObserver<T, R> extends AtomicReference<Disposable> implements Observer<R>, C8058k<T>, Disposable {
    private static final long serialVersionUID = -8948264376121066672L;
    public final Observer<? super R> downstream;
    public final C8339g<? super T, ? extends C8065q<? extends R>> mapper;

    public MaybeFlatMapObservable$FlatMapObserver(Observer<? super R> observer, C8339g<? super T, ? extends C8065q<? extends R>> gVar) {
