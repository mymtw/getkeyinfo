...
final class MaybeFlatMapIterableFlowable$FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements C8058k<T> {
    private static final long serialVersionUID = -8938804753851907758L;
    public volatile boolean cancelled;
    public final C20024c<? super R> downstream;

    /* renamed from: it */
    public volatile Iterator<? extends R> f42705it;
    public final C8339g<? super T, ? extends Iterable<? extends R>> mapper;
    public boolean outputFused;
    public final AtomicLong requested = new AtomicLong();
    public Disposable upstream;

    public MaybeFlatMapIterableFlowable$FlatMapIterableObserver(C20024c<? super R> cVar, C8339g<? super T, ? extends Iterable<? extends R>> gVar) {
    ...
    public void drain() {
        if (getAndIncrement() == 0) {
            ...
            Iterator<? extends R> it = this.f42705it;
    ...
    public void fastPath(C20024c<? super R> cVar, Iterator<? extends R> it) {
