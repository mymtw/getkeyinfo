...
final class ObservableGroupJoin$GroupJoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, C19171l {
    ...
    public final C8335c<? super TLeft, ? super C8061n<TRight>, ? extends R> resultSelector;
    public final C8339g<? super TRight, ? extends C8065q<TRightEnd>> rightEnd;
    public int rightIndex;
    public final Map<Integer, TRight> rights = new LinkedHashMap();

    public ObservableGroupJoin$GroupJoinDisposable(Observer<? super R> observer, C8339g<? super TLeft, ? extends C8065q<TLeftEnd>> gVar, C8339g<? super TRight, ? extends C8065q<TRightEnd>> gVar2, C8335c<? super TLeft, ? super C8061n<TRight>, ? extends R> cVar) {
        ...
        if (getAndIncrement() == 0) {
            ...
            while (!this.cancelled) {
                ...
                if (z && z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        UnicastSubject unicastSubject = new UnicastSubject(C8054g.f17572b);
                        ...
                        try {
                            ...
                            C12965a.m20650b(apply3, "The rightEnd returned a null ObservableSource");
                            C8065q qVar2 = (C8065q) apply3;
