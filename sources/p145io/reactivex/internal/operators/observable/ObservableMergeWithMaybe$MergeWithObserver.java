...
final class ObservableMergeWithMaybe$MergeWithObserver<T> extends AtomicInteger implements Observer<T>, Disposable {
    ...
    public static final class OtherObserver<T> extends AtomicReference<Disposable> implements C8058k<T> {
    ...
    public ObservableMergeWithMaybe$MergeWithObserver(Observer<? super T> observer) {
