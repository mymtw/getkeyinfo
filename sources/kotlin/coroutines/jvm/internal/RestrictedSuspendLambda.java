...
public abstract class RestrictedSuspendLambda extends RestrictedContinuationImpl implements C19381m<Object> {
    private final int arity;

    public RestrictedSuspendLambda(int i, C19340c<Object> cVar) {
        super(cVar);
        this.arity = i;
    }
