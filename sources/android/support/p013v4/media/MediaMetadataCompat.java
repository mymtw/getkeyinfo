...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final C7494b<String, Integer> METADATA_KEYS_TYPE;
    ...
    static {
        C7494b<String, Integer> bVar = new C7494b<>();
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            C7494b<String, Integer> bVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!bVar.containsKey(str) || bVar.getOrDefault(str, null).intValue() == 2) {
                this.mBundle.putParcelable(str, bitmap);
                return this;
            }
            throw new IllegalArgumentException(C0048b.m163a("The ", str, " key cannot be used to put a Bitmap"));
        }
        ...
        public Builder putLong(String str, long j) {
            ...
            throw new IllegalArgumentException(C0048b.m163a("The ", str, " key cannot be used to put a long"));
        }

        public Builder putRating(String str, RatingCompat ratingCompat) {
            C7494b<String, Integer> bVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!bVar.containsKey(str) || bVar.getOrDefault(str, null).intValue() == 3) {
                this.mBundle.putParcelable(str, (Parcelable) ratingCompat.getRating());
                return this;
            }
            throw new IllegalArgumentException(C0048b.m163a("The ", str, " key cannot be used to put a Rating"));
        }
        ...
        public Builder putString(String str, String str2) {
            ...
            throw new IllegalArgumentException(C0048b.m163a("The ", str, " key cannot be used to put a String"));
        }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ...
            throw new IllegalArgumentException(C0048b.m163a("The ", str, " key cannot be used to put a CharSequence"));
        }
