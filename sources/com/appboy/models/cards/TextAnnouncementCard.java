...
public final class TextAnnouncementCard extends Card {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public TextAnnouncementCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public TextAnnouncementCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var, C3475a<?> aVar) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ TextAnnouncementCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var, C3475a aVar, C4318z1 z1Var, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public TextAnnouncementCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var, C3475a<?> aVar, C4318z1 z1Var) {
        ...
        C19383o.m32796f(string, "jsonObject.getString(car…NNOUNCEMENT_DESCRIPTION))");
        this.description = string;
        this.title = JsonUtils.m11314e(provider.getKey(CardKey.TEXT_ANNOUNCEMENT_TITLE), jSONObject);
        this.url = JsonUtils.m11314e(provider.getKey(CardKey.TEXT_ANNOUNCEMENT_URL), jSONObject);
        this.domain = JsonUtils.m11314e(provider.getKey(CardKey.TEXT_ANNOUNCEMENT_DOMAIN), jSONObject);
