...
public final class CaptionedImageCard extends Card {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var, C3475a<?> aVar) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var, C3475a aVar, C4318z1 z1Var, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public CaptionedImageCard(JSONObject jSONObject, CardKey.Provider provider, C4274x1 x1Var, C3475a<?> aVar, C4318z1 z1Var) {
        ...
        C19383o.m32796f(string, "jsonObject.getString(car…y.CAPTIONED_IMAGE_IMAGE))");
        this.imageUrl = string;
        String string2 = jSONObject.getString(provider.getKey(CardKey.CAPTIONED_IMAGE_TITLE));
        C19383o.m32796f(string2, "jsonObject.getString(car…y.CAPTIONED_IMAGE_TITLE))");
        this.title = string2;
        String string3 = jSONObject.getString(provider.getKey(CardKey.CAPTIONED_IMAGE_DESCRIPTION));
        C19383o.m32796f(string3, "jsonObject.getString(car…IONED_IMAGE_DESCRIPTION))");
        this.description = string3;
        this.url = JsonUtils.m11314e(provider.getKey(CardKey.CAPTIONED_IMAGE_URL), jSONObject);
        this.domain = JsonUtils.m11314e(provider.getKey(CardKey.CAPTIONED_IMAGE_DOMAIN), jSONObject);
        this.aspectRatio = (float) jSONObject.optDouble(provider.getKey(CardKey.CAPTIONED_IMAGE_ASPECT_RATIO), ShadowDrawableWrapper.COS_45);
