...
public final class BaseCardView$handleCardClick$1 extends Lambda implements C19846a<String> {
    ...
    public final String invoke() {
        return C19383o.m32802l(this.$card, "Handling card click for card: ");
    }
}
