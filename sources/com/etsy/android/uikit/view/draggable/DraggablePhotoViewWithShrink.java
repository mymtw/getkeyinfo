...
public final class DraggablePhotoViewWithShrink extends PhotoView implements View.OnTouchListener, C13532h {
    ...
    /* renamed from: com.etsy.android.uikit.view.draggable.DraggablePhotoViewWithShrink$a */
    public static final class C11934a implements C11948c {

        /* renamed from: a */
        public final /* synthetic */ C19846a<C19394m> f26537a;

        public C11934a(C19846a<C19394m> aVar) {
            this.f26537a = aVar;
        }
    ...
    /* renamed from: com.etsy.android.uikit.view.draggable.DraggablePhotoViewWithShrink$b */
    public static final class C11935b implements C11949d {

        /* renamed from: a */
        public final /* synthetic */ C19846a<C19394m> f26538a;

        public C11935b(C19846a<C19394m> aVar) {
            this.f26538a = aVar;
        }
    ...
    public DraggablePhotoViewWithShrink(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this._$_findViewCache = C13983i.m21496o(context, ResponseConstants.CONTEXT);
        this.eventHandler$delegate = C19350d.m32677b(new DraggablePhotoViewWithShrink$eventHandler$2(context, this));
        this.doubleTapEventHandler$delegate = C19350d.m32677b(new DraggablePhotoViewWithShrink$doubleTapEventHandler$2(context, this));
    ...
    public final void cleanup() {
        ...
        ImageView imageView = eventHandler.f26522g;
        if (imageView != null) {
            eventHandler.f26516a.removeView(imageView);
        }
        View view = eventHandler.f26523h;
        if (view != null) {
            eventHandler.f26516a.removeView(view);
        }
    }
    ...
    public void onDrag(float f, float f2) {
        ...
        C11943b bVar = getEventHandler().f26520e;
        if (getAttacher().getScale() == 1.0f) {
            getEventHandler().mo38664a(f, f2);
        }
        C11943b bVar2 = getEventHandler().f26520e;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerCount() > 1) {
            z = C19383o.m32792b(eventHandler.f26520e, C11943b.C11946c.f26548a);
        }
        if (z) {
            getEventHandler().mo38667d(motionEvent);
        }
        C11943b bVar2 = getEventHandler().f26520e;
    ...
    public final void setImageDoubleTapListener(C19846a<C19394m> aVar) {
        ...
        this.doubleTapListener = new C11934a(aVar);
    }

    public final void setImageSwipeDownListener(C19846a<C19394m> aVar) {
        C19383o.m32797g(aVar, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
        this.swipeListener = new C11935b(aVar);
    }
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ DraggablePhotoViewWithShrink(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
