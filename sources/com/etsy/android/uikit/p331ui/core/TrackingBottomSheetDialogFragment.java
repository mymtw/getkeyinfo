...
/* renamed from: com.etsy.android.uikit.ui.core.TrackingBottomSheetDialogFragment */
public abstract class TrackingBottomSheetDialogFragment extends BottomSheetDialogFragment implements C8693g {
    ...
    public C8703p getAnalyticsContext() {
        return this.trackingDelegate.f26437d;
    }
    ...
    public final C8703p requireAnalyticsContext() {
        C8703p pVar = this.trackingDelegate.f26437d;
        if (pVar != null) {
            return pVar;
        }
        throw new IllegalStateException(this + " has not yet been created.");
    }

    public void setUserVisibleHint(boolean z) {
        super.setUserVisibleHint(z);
        this.trackingDelegate.mo38422f(z);
    }
