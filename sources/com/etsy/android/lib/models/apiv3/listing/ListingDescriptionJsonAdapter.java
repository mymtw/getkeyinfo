...
public final class ListingDescriptionJsonAdapter extends JsonAdapter<ListingDescription> {
    ...
    private final JsonReader.C17362b options = JsonReader.C17362b.m29110a("name", "value");

    public ListingDescriptionJsonAdapter(C17414y yVar) {
    ...
    public void toJson(C17412w wVar, ListingDescription listingDescription) {
        C19383o.m32797g(wVar, "writer");
        if (listingDescription != null) {
            wVar.mo68522b();
            wVar.mo68529h("name");
            this.nullableStringAdapter.toJson(wVar, listingDescription.getName());
            wVar.mo68529h("value");
            this.nullableStringAdapter.toJson(wVar, listingDescription.getValue());
            wVar.mo68526f();
            return;
        }
