...
public final class Subrating_ShippingJsonAdapter extends JsonAdapter<Subrating.Shipping> {
    ...
    public Subrating_ShippingJsonAdapter(C17414y yVar) {
    ...
    public void toJson(C17412w wVar, Subrating.Shipping shipping) {
        C19383o.m32797g(wVar, "writer");
        if (shipping != null) {
            wVar.mo68522b();
            wVar.mo68529h("average");
            this.nullableFloatAdapter.toJson(wVar, shipping.getAverage());
            wVar.mo68526f();
            return;
        }
