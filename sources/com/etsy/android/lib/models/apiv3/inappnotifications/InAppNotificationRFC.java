...
public final class InAppNotificationRFC extends InAppNotification {
    ...
    public /* synthetic */ InAppNotificationRFC(String str, Long l, String str2, String str3, long j, ShopIcon shopIcon2, InAppNotificationClickType inAppNotificationClickType, List list, boolean z, String str4, String str5, boolean z2, String str6, String str7, long j2, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (i & 2) != 0 ? null : l, str2, str3, j, shopIcon2, inAppNotificationClickType, list, z, str4, str5, z2, str6, str7, j2, list2);
    }

    public static /* synthetic */ InAppNotificationRFC copy$default(InAppNotificationRFC inAppNotificationRFC, String str, Long l, String str2, String str3, long j, ShopIcon shopIcon2, InAppNotificationClickType inAppNotificationClickType, List list, boolean z, String str4, String str5, boolean z2, String str6, String str7, long j2, List list2, int i, Object obj) {
        InAppNotificationRFC inAppNotificationRFC2 = inAppNotificationRFC;
        int i2 = i;
        return inAppNotificationRFC.copy((i2 & 1) != 0 ? inAppNotificationRFC2.feedId : str, (i2 & 2) != 0 ? inAppNotificationRFC2.feedIndex : l, (i2 & 4) != 0 ? inAppNotificationRFC2.text : str2, (i2 & 8) != 0 ? inAppNotificationRFC2.timePassed : str3, (i2 & 16) != 0 ? inAppNotificationRFC2.shopId : j, (i2 & 32) != 0 ? inAppNotificationRFC2.shopIcon : shopIcon2, (i2 & 64) != 0 ? inAppNotificationRFC2.clickType : inAppNotificationClickType, (i2 & 128) != 0 ? inAppNotificationRFC2.listings : list, (i2 & 256) != 0 ? inAppNotificationRFC2.isRead : z, (i2 & RecyclerView.C3084b0.FLAG_ADAPTER_POSITION_UNKNOWN) != 0 ? inAppNotificationRFC2.buttonText : str4, (i2 & RecyclerView.C3084b0.FLAG_ADAPTER_FULLUPDATE) != 0 ? inAppNotificationRFC2.couponCode : str5, (i2 & RecyclerView.C3084b0.FLAG_MOVED) != 0 ? inAppNotificationRFC2.buttonEnabled : z2, (i2 & RecyclerView.C3084b0.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? inAppNotificationRFC2.promoText : str6, (i2 & 8192) != 0 ? inAppNotificationRFC2.unavailableText : str7, (i2 & PrimitiveArrayBuilder.SMALL_CHUNK_SIZE) != 0 ? inAppNotificationRFC2.promoOfferId : j2, (i2 & 32768) != 0 ? inAppNotificationRFC2.promoOfferTokens : list2);
    }
    ...
    public final InAppNotificationRFC copy(@C17402n(name = "notification_feed_id") String str, @C17402n(name = "notification_feed_index") Long l, @C17402n(name = "notification_text") String str2, @C17402n(name = "notification_time_passed") String str3, @C17402n(name = "shop_id") long j, @C17402n(name = "notification_shop_img") ShopIcon shopIcon2, @C17402n(name = "notification_click_type") InAppNotificationClickType inAppNotificationClickType, @C17402n(name = "listings") List<IANListingCard> list, @C17402n(name = "read") boolean z, @C17402n(name = "button_text") String str4, @C17402n(name = "coupon_code") String str5, @C17402n(name = "button_enabled") boolean z2, @C17402n(name = "promotion_text") String str6, @C17402n(name = "unavailable_message") String str7, @C17402n(name = "promoted_offer_id") long j2, @C17402n(name = "promoted_offer_listing_tokens") List<String> list2) {
        ...
        return new InAppNotificationRFC(str8, l, str2, str3, j, shopIcon2, inAppNotificationClickType, list, z, str4, str5, z2, str6, str7, j2, list2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C19383o.m32792b(this.feedId, inAppNotificationRFC.feedId) && C19383o.m32792b(this.feedIndex, inAppNotificationRFC.feedIndex) && C19383o.m32792b(this.text, inAppNotificationRFC.text) && C19383o.m32792b(this.timePassed, inAppNotificationRFC.timePassed) && this.shopId == inAppNotificationRFC.shopId && C19383o.m32792b(this.shopIcon, inAppNotificationRFC.shopIcon) && this.clickType == inAppNotificationRFC.clickType && C19383o.m32792b(this.listings, inAppNotificationRFC.listings) && this.isRead == inAppNotificationRFC.isRead && C19383o.m32792b(this.buttonText, inAppNotificationRFC.buttonText) && C19383o.m32792b(this.couponCode, inAppNotificationRFC.couponCode) && this.buttonEnabled == inAppNotificationRFC.buttonEnabled && C19383o.m32792b(this.promoText, inAppNotificationRFC.promoText) && C19383o.m32792b(this.unavailableText, inAppNotificationRFC.unavailableText) && this.promoOfferId == inAppNotificationRFC.promoOfferId && C19383o.m32792b(this.promoOfferTokens, inAppNotificationRFC.promoOfferTokens);
    }
    ...
    public String toString() {
        StringBuilder h = C0072d.m201h("InAppNotificationRFC(feedId=");
