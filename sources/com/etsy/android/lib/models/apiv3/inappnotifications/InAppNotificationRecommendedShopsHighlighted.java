...
public final class InAppNotificationRecommendedShopsHighlighted extends InAppNotification {
    ...
    public /* synthetic */ InAppNotificationRecommendedShopsHighlighted(String str, Long l, String str2, String str3, boolean z, LandingPageLink landingPageLink2, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (i & 2) != 0 ? null : l, str2, str3, z, (i & 32) != 0 ? null : landingPageLink2, list);
    }

    public static /* synthetic */ InAppNotificationRecommendedShopsHighlighted copy$default(InAppNotificationRecommendedShopsHighlighted inAppNotificationRecommendedShopsHighlighted, String str, Long l, String str2, String str3, boolean z, LandingPageLink landingPageLink2, List<IANShopCard> list, int i, Object obj) {
        if ((i & 1) != 0) {
            str = inAppNotificationRecommendedShopsHighlighted.feedId;
        }
        if ((i & 2) != 0) {
            l = inAppNotificationRecommendedShopsHighlighted.feedIndex;
        }
        Long l2 = l;
        if ((i & 4) != 0) {
        ...
        String str5 = str3;
        if ((i & 16) != 0) {
            z = inAppNotificationRecommendedShopsHighlighted.isRead;
        }
        boolean z2 = z;
        if ((i & 32) != 0) {
            landingPageLink2 = inAppNotificationRecommendedShopsHighlighted.landingPageLink;
        }
        LandingPageLink landingPageLink3 = landingPageLink2;
        if ((i & 64) != 0) {
            list = inAppNotificationRecommendedShopsHighlighted.recommendedShops;
        }
        return inAppNotificationRecommendedShopsHighlighted.copy(str, l2, str4, str5, z2, landingPageLink3, list);
    }
    ...
    public final InAppNotificationRecommendedShopsHighlighted copy(@C17402n(name = "notification_feed_id") String str, @C17402n(name = "notification_feed_index") Long l, @C17402n(name = "notification_text") String str2, @C17402n(name = "notification_subtext") String str3, @C17402n(name = "read") boolean z, @C17402n(name = "landing_page") LandingPageLink landingPageLink2, @C17402n(name = "recommended_shops") List<IANShopCard> list) {
        ...
        return new InAppNotificationRecommendedShopsHighlighted(str, l, str2, str3, z, landingPageLink2, list2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C19383o.m32792b(this.feedId, inAppNotificationRecommendedShopsHighlighted.feedId) && C19383o.m32792b(this.feedIndex, inAppNotificationRecommendedShopsHighlighted.feedIndex) && C19383o.m32792b(this.text, inAppNotificationRecommendedShopsHighlighted.text) && C19383o.m32792b(this.subText, inAppNotificationRecommendedShopsHighlighted.subText) && this.isRead == inAppNotificationRecommendedShopsHighlighted.isRead && C19383o.m32792b(this.landingPageLink, inAppNotificationRecommendedShopsHighlighted.landingPageLink) && C19383o.m32792b(this.recommendedShops, inAppNotificationRecommendedShopsHighlighted.recommendedShops);
    }
    ...
    public String toString() {
        StringBuilder h = C0072d.m201h("InAppNotificationRecommendedShopsHighlighted(feedId=");
    ...
    public InAppNotificationRecommendedShopsHighlighted(@C17402n(name = "notification_feed_id") String str, @C17402n(name = "notification_feed_index") Long l, @C17402n(name = "notification_text") String str2, @C17402n(name = "notification_subtext") String str3, @C17402n(name = "read") boolean z, @C17402n(name = "landing_page") LandingPageLink landingPageLink2, @C17402n(name = "recommended_shops") List<IANShopCard> list) {
