...
public final class InAppNotificationAbandonedCartOfferJsonAdapter extends JsonAdapter<InAppNotificationAbandonedCartOffer> {
    public static final int $stable = 8;
    private final JsonAdapter<Boolean> booleanAdapter;
    private volatile Constructor<InAppNotificationAbandonedCartOffer> constructorRef;
    ...
    public InAppNotificationAbandonedCartOfferJsonAdapter(C17414y yVar) {
        C17414y yVar2 = yVar;
    ...
    public String toString() {
        return "GeneratedJsonAdapter(InAppNotificationAbandonedCartOffer)";
    }
    ...
    public com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer fromJson(com.squareup.moshi.JsonReader r46) {
        /*
            r45 = this;
            r0 = r45
            r1 = r46
        ...
        L_0x021b:
            ...
            com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer r0 = new com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer
        ...
        L_0x0291:
            ...
            r39 = r37
            r40 = r38
            java.lang.reflect.Constructor<com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer> r6 = r0.constructorRef
            r35 = 1
            r37 = 0
            r38 = r5
            r5 = 18
            if (r6 != 0) goto L_0x030d
            java.lang.Class<com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer> r6 = com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer.class
            r41 = r13
            ...
            java.lang.String r13 = "InAppNotificationAbandon…his.constructorRef = it }"
        ...
        L_0x030f:
            ...
            com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer r1 = (com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer) r1
            return r1
        L_0x0390:
        ...
        L_0x03bb:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOfferJsonAdapter.fromJson(com.squareup.moshi.JsonReader):com.etsy.android.lib.models.apiv3.inappnotifications.InAppNotificationAbandonedCartOffer");
    }

    public void toJson(C17412w wVar, InAppNotificationAbandonedCartOffer inAppNotificationAbandonedCartOffer) {
        C19383o.m32797g(wVar, "writer");
        if (inAppNotificationAbandonedCartOffer != null) {
            wVar.mo68522b();
            wVar.mo68529h("notification_feed_id");
            this.stringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getFeedId());
            wVar.mo68529h("notification_feed_index");
            this.nullableLongAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getFeedIndex());
            wVar.mo68529h("notification_text");
            this.nullableStringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getText());
            wVar.mo68529h("notification_time_passed");
            this.nullableStringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getTimePassed());
            wVar.mo68529h("shop_id");
            this.longAdapter.toJson(wVar, Long.valueOf(inAppNotificationAbandonedCartOffer.getShopId()));
            wVar.mo68529h("notification_shop_img");
            this.nullableShopIconAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getShopIcon());
            wVar.mo68529h("notification_click_type");
            this.inAppNotificationClickTypeAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getClickType());
            wVar.mo68529h("listings");
            this.nullableListOfIANListingCardAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getListings());
            wVar.mo68529h("read");
            this.booleanAdapter.toJson(wVar, Boolean.valueOf(inAppNotificationAbandonedCartOffer.isRead()));
            wVar.mo68529h(ResponseConstants.BUTTON_TEXT);
            this.nullableStringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getButtonText());
            wVar.mo68529h("coupon_code");
            this.stringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getCouponCode());
            wVar.mo68529h("button_enabled");
            this.booleanAdapter.toJson(wVar, Boolean.valueOf(inAppNotificationAbandonedCartOffer.getButtonEnabled()));
            wVar.mo68529h("promotion_text");
            this.stringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getPromoText());
            wVar.mo68529h("unavailable_message");
            this.nullableStringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getUnavailableText());
            wVar.mo68529h("promoted_offer_id");
            this.longAdapter.toJson(wVar, Long.valueOf(inAppNotificationAbandonedCartOffer.getPromoOfferId()));
            wVar.mo68529h("promoted_offer_listing_tokens");
            this.nullableListOfStringAdapter.toJson(wVar, inAppNotificationAbandonedCartOffer.getPromoOfferTokens());
            wVar.mo68526f();
            return;
        }
