...
public final class MainImageJsonAdapter extends JsonAdapter<MainImage> {
    ...
    private final JsonReader.C17362b options = JsonReader.C17362b.m29110a(ResponseConstants.URL_FULLxFULL);

    public MainImageJsonAdapter(C17414y yVar) {
        C19383o.m32797g(yVar, "moshi");
        this.nullableStringAdapter = yVar.mo68558c(String.class, EmptySet.INSTANCE, "urlFullxfull");
    }
    ...
    public void toJson(C17412w wVar, MainImage mainImage) {
        ...
        if (mainImage != null) {
            ...
            this.nullableStringAdapter.toJson(wVar, mainImage.getUrlFullxfull());
            wVar.mo68526f();
            return;
        }
