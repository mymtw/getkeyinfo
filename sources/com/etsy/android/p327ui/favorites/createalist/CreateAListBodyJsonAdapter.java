...
/* renamed from: com.etsy.android.ui.favorites.createalist.CreateAListBodyJsonAdapter */
public final class CreateAListBodyJsonAdapter extends JsonAdapter<CreateAListBody> {
    ...
    public CreateAListBodyJsonAdapter(C17414y yVar) {
    ...
    public final Object fromJson(JsonReader jsonReader) {
        ...
        if (str == null) {
            ...
            return new CreateAListBody(str, list, str2);
        } else {
    ...
    public final void toJson(C17412w wVar, Object obj) {
        ...
        if (createAListBody != null) {
            wVar.mo68522b();
            wVar.mo68529h("name");
            this.stringAdapter.toJson(wVar, createAListBody.f21653a);
            wVar.mo68529h(ResponseConstants.LISTING_IDS);
            this.nullableListOfNullableLongAdapter.toJson(wVar, createAListBody.f21654b);
            wVar.mo68529h(ResponseConstants.PRIVACY_LEVEL);
            this.stringAdapter.toJson(wVar, createAListBody.f21655c);
            wVar.mo68526f();
            return;
        }
    ...
    public final String toString() {
        return "GeneratedJsonAdapter(CreateAListBody)";
    }
}
