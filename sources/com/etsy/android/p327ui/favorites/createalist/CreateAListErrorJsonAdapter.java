...
/* renamed from: com.etsy.android.ui.favorites.createalist.CreateAListErrorJsonAdapter */
public final class CreateAListErrorJsonAdapter extends JsonAdapter<CreateAListError> {
    ...
    public CreateAListErrorJsonAdapter(C17414y yVar) {
    ...
    public final void toJson(C17412w wVar, Object obj) {
        CreateAListError createAListError = (CreateAListError) obj;
        C19383o.m32797g(wVar, "writer");
        if (createAListError != null) {
            wVar.mo68522b();
            wVar.mo68529h("error");
            this.nullableStringAdapter.toJson(wVar, createAListError.f21664a);
            wVar.mo68526f();
            return;
        }
