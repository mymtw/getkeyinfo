...
/* renamed from: com.etsy.android.ui.cart.pushoptin.PushOptInBottomSheetFragment */
public final class PushOptInBottomSheetFragment extends TrackingBottomSheetDialogFragment {
    ...
    public final void toNotificationSettings() {
        ...
        if (context != null) {
            ...
            if (analyticsContext != null) {
                analyticsContext.mo21333d("push_opt_in_redirect_to_settings", C19421p.m32931U(new Pair(PredefinedAnalyticsProperty.PUSH_OPT_IN_DISPLAY_LOCATION, "postPurchase")));
            }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ViewExtensions.m12866j(button, new PushOptInBottomSheetFragment$onCreateView$1(this));
        Button button2 = (Button) inflate.findViewById(R.id.opt_in_no_thanks);
        C19383o.m32796f(button2, "dismissButton");
        ViewExtensions.m12866j(button2, new PushOptInBottomSheetFragment$onCreateView$2(this));
        return inflate;
    }
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        if (this.userDismissed && (analyticsContext = getAnalyticsContext()) != null) {
            analyticsContext.mo21333d("push_opt_in_sheet_dismissed", C19421p.m32931U(new Pair(PredefinedAnalyticsProperty.PUSH_OPT_IN_DISPLAY_LOCATION, "postPurchase")));
        }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        C8703p analyticsContext = getAnalyticsContext();
        if (analyticsContext != null) {
            analyticsContext.mo21333d("display_push_opt_in_prompt", C19421p.m32931U(new Pair(PredefinedAnalyticsProperty.PUSH_OPT_IN_DISPLAY_LOCATION, "postPurchase")));
        }
    }
}
