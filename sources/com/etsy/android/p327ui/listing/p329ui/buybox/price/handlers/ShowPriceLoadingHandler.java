...
/* renamed from: com.etsy.android.ui.listing.ui.buybox.price.handlers.ShowPriceLoadingHandler */
public final class ShowPriceLoadingHandler {
    /* renamed from: a */
    public static C13574d.C13594c m18352a(ListingViewState.C10092d dVar) {
        C10423j jVar = dVar.f22238f.f22802e.f22818c;
        C12974d dVar2 = null;
        C12971a aVar = jVar instanceof C12971a ? (C12971a) jVar : null;
        C12971a b = aVar != null ? C12971a.m20653b(aVar, (C10563f) null, true, 7) : null;
        C10423j jVar2 = dVar.f22238f.f22802e.f22818c;
        C12974d dVar3 = jVar2 instanceof C12974d ? (C12974d) jVar2 : null;
        if (dVar3 != null) {
            dVar2 = C12974d.m20657b(dVar3, (C10563f) null, true, 31);
        }
        return C0761x.m1709a1(dVar, new ShowPriceLoadingHandler$handle$1(b, dVar2));
    }
}
