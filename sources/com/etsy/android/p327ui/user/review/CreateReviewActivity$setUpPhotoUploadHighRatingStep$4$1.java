...
/* renamed from: com.etsy.android.ui.user.review.CreateReviewActivity$setUpPhotoUploadHighRatingStep$4$1 */
public final class CreateReviewActivity$setUpPhotoUploadHighRatingStep$4$1 extends Lambda implements C19857l<View, C19394m> {
    public final /* synthetic */ C11719r.C11741v $state;
    public final /* synthetic */ CreateReviewActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CreateReviewActivity$setUpPhotoUploadHighRatingStep$4$1(C11719r.C11741v vVar, CreateReviewActivity createReviewActivity) {
        super(1);
        this.$state = vVar;
    ...
    public final void invoke(View view) {
        String g0;
        ITrackedObject iTrackedObject = this.$state.f26152h;
