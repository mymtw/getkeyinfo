...
/* renamed from: com.etsy.android.ui.user.review.CreateReviewActivity$showAddPhotoPopup$1$1 */
public final class CreateReviewActivity$showAddPhotoPopup$1$1 extends Lambda implements C19857l<View, C19394m> {
    ...
    public CreateReviewActivity$showAddPhotoPopup$1$1(C11719r.C11720a aVar, CollageBottomSheet collageBottomSheet, CreateReviewActivity createReviewActivity, CreateReviewActivity createReviewActivity2) {
        super(1);
        this.$state = aVar;
    ...
    public final void invoke(View view) {
        String g0;
        ITrackedObject iTrackedObject = this.$state.f26070d;
