...
/* renamed from: com.etsy.android.ui.user.inappnotifications.InAppNotificationsFragment$onCreateView$1 */
public final class InAppNotificationsFragment$onCreateView$1 extends Lambda implements C19857l<String, C19394m> {
    public final /* synthetic */ InAppNotificationsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InAppNotificationsFragment$onCreateView$1(InAppNotificationsFragment inAppNotificationsFragment) {
        super(1);
