...
/* renamed from: com.etsy.android.ui.user.addresses.AddressListFragment$special$$inlined$viewModels$default$2 */
public final class AddressListFragment$special$$inlined$viewModels$default$2 extends Lambda implements C19846a<C2878l0> {
    public final /* synthetic */ C19846a $ownerProducer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddressListFragment$special$$inlined$viewModels$default$2(C19846a aVar) {
        super(0);
