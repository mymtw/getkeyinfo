...
final class NioByteString extends ByteString.LeafByteString {
    ...
    /* renamed from: c */
    public final ByteBuffer mo58568c(int i, int i2) {
    ...
    public boolean isValidUtf8() {
        ...
        return Utf8.f36555a.mo58596e(0, byteBuffer.position(), byteBuffer.remaining(), byteBuffer) == 0;
    }

    public C16497i newCodedInput() {
        ByteBuffer byteBuffer = this.buffer;
        if (byteBuffer.hasArray()) {
            return C16497i.m26921f(byteBuffer.array(), byteBuffer.position() + byteBuffer.arrayOffset(), byteBuffer.remaining(), true);
        } else if (byteBuffer.isDirect() && C16488g1.f36613e) {
            return new C16497i.C16500c(byteBuffer);
        } else {
            int remaining = byteBuffer.remaining();
            byte[] bArr = new byte[remaining];
            byteBuffer.duplicate().get(bArr);
            return C16497i.m26921f(bArr, 0, remaining, true);
        }
    }

    public InputStream newInput() {
        return new C16436a(this);
    }
    ...
    public int partialIsValidUtf8(int i, int i2, int i3) {
        ByteBuffer byteBuffer = this.buffer;
        return Utf8.f36555a.mo58596e(i, i2, i3 + i2, byteBuffer);
    }
    ...
    public ByteString substring(int i, int i2) {
        try {
            return new NioByteString(mo58568c(i, i2));
        } catch (ArrayIndexOutOfBoundsException e) {
            throw e;
        } catch (IndexOutOfBoundsException e2) {
            throw new ArrayIndexOutOfBoundsException(e2.getMessage());
    ...
    public void writeToInternal(java.io.OutputStream r9, int r10, int r11) throws java.io.IOException {
        ...
        L_0x0020:
            int r11 = r11 + r10
            java.nio.ByteBuffer r10 = r8.mo58568c(r10, r11)
            java.lang.ThreadLocal<java.lang.ref.SoftReference<byte[]>> r11 = com.google.crypto.tink.shaded.protobuf.C16486g.f36604a
            ...
            goto L_0x00be
        L_0x0047:
            long r0 = com.google.crypto.tink.shaded.protobuf.C16486g.f36606c     // Catch:{ all -> 0x00c2 }
            r2 = 0
            ...
            java.lang.Class<?> r2 = com.google.crypto.tink.shaded.protobuf.C16486g.f36605b     // Catch:{ all -> 0x00c2 }
            boolean r2 = r2.isInstance(r9)     // Catch:{ all -> 0x00c2 }
            if (r2 == 0) goto L_0x0069
            java.lang.Object r0 = com.google.crypto.tink.shaded.protobuf.C16488g1.m26849o(r0, r9)     // Catch:{ ClassCastException -> 0x0061 }
        ...
        L_0x006a:
            ...
            java.lang.ThreadLocal<java.lang.ref.SoftReference<byte[]>> r1 = com.google.crypto.tink.shaded.protobuf.C16486g.f36604a     // Catch:{ all -> 0x00c2 }
    ...
    public class C16436a extends InputStream {

        /* renamed from: b */
        public final ByteBuffer f36542b;

        public C16436a(NioByteString nioByteString) {
            this.f36542b = nioByteString.buffer.slice();
        }

        public final int available() throws IOException {
            return this.f36542b.remaining();
        }
        ...
        public final int read() throws IOException {
            if (!this.f36542b.hasRemaining()) {
                return -1;
            }
            return this.f36542b.get() & 255;
        }
        ...
        public final int read(byte[] bArr, int i, int i2) throws IOException {
            ...
            int min = Math.min(i2, this.f36542b.remaining());
            this.f36542b.get(bArr, i, min);
            return min;
        }
    }

    public void writeTo(C16494h hVar) throws IOException {
        hVar.mo58514b(this.buffer.slice());
    }
}
