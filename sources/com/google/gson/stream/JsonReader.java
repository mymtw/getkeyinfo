...
public class JsonReader implements Closeable {
    ...
    private final char[] buffer = new char[RecyclerView.C3084b0.FLAG_ADAPTER_FULLUPDATE];

    /* renamed from: in */
    private final Reader f37126in;
    ...
    static {
        C16789f.INSTANCE = new C16789f() {
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof C16780a) {
                    C16780a aVar = (C16780a) jsonReader;
                    aVar.getClass();
                    aVar.mo59583a(JsonToken.NAME);
                    Map.Entry entry = (Map.Entry) ((Iterator) aVar.mo59584b()).next();
                    aVar.mo59589e(entry.getValue());
                    aVar.mo59589e(new C16803q((String) entry.getKey()));
                    return;
                }
                ...
                if (i == 13) {
                    ...
                    h.append(jsonReader.locationString());
        ...
        while (true) {
            if (i == i2) {
                ...
                if (fillBuffer(1)) {
                    ...
                    StringBuilder h = C0072d.m201h("End of input");
                    ...
                    while (i5 < i6) {
                        ...
                        if (c3 < '0' || c3 > '9') {
                            if (c3 >= 'a' && c3 <= 'f') {
                                ...
                                h.append(new String(this.buffer, this.pos, 4));
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        h.append(locationString());
        throw new MalformedJsonException(h.toString());
    }
    ...
    public String locationString() {
        StringBuilder g = C0472h.m1244g(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        g.append(getPath());
        return g.toString();
    }
    ...
    public int nextInt() throws IOException {
        ...
        h3.append(this.peekedString);
        h3.append(locationString());
        throw new NumberFormatException(h3.toString());
    }
