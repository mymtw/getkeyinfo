...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo49213id = 4)
    private PendingIntent zzbv;
    @SafeParcelable.Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo49213id = 1)
    private int zzcg;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo49213id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @SafeParcelable.Field(defaultValueUnchecked = "null", mo49213id = 2)
    private zzbd zzdl;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo49213id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @SafeParcelable.Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo49213id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @SafeParcelable.Constructor
    public zzbf(@SafeParcelable.Param(mo49216id = 1) int i, @SafeParcelable.Param(mo49216id = 2) zzbd zzbd, @SafeParcelable.Param(mo49216id = 3) IBinder iBinder, @SafeParcelable.Param(mo49216id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(mo49216id = 5) IBinder iBinder2, @SafeParcelable.Param(mo49216id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
