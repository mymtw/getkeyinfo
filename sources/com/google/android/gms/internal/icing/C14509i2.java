...
/* renamed from: com.google.android.gms.internal.icing.i2 */
public final class C14509i2 {

    /* renamed from: a */
    public static final C19421p f32649a = new C19421p();

    static {
        if (C14505h2.f32646e && C14505h2.f32645d) {
            int i = C14514k.f32654a;
        }
    }

    /* renamed from: a */
    public static int m23046a(CharSequence charSequence) {
    ...
    /* renamed from: b */
    public static int m23047b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char charAt;
    ...
    /* renamed from: c */
    public static /* synthetic */ int m23048c(int i, int i2, byte[] bArr) {
        byte b = bArr[i - 1];
        int i3 = i2 - i;
        if (i3 != 0) {
            if (i3 == 1) {
