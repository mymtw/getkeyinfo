...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", mo49213id = 1)
    private final Status zzbl;
    @SafeParcelable.Field(getter = "getLocationSettingsStates", mo49213id = 2)
    ...
    public LocationSettingsResult(@SafeParcelable.Param(mo49216id = 1) Status status, @SafeParcelable.Param(mo49216id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
