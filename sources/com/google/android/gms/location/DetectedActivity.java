...
public class DetectedActivity extends AbstractSafeParcelable {
    ...
    private static final Comparator<DetectedActivity> zzo = new C14021g();
    ...
    public DetectedActivity(@SafeParcelable.Param(mo49216id = 1) int i, @SafeParcelable.Param(mo49216id = 2) int i2) {
        this.zzi = i;
        this.zzs = i2;
    }
    ...
    public String toString() {
        ...
        int i = this.zzs;
        StringBuilder sb = new StringBuilder(C0391c.m1055a(str, 48));
