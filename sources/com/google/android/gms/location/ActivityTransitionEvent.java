...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getElapsedRealTimeNanos", mo49213id = 3)
    private final long zzk;

    @SafeParcelable.Constructor
    public ActivityTransitionEvent(@SafeParcelable.Param(mo49216id = 1) int i, @SafeParcelable.Param(mo49216id = 2) int i2, @SafeParcelable.Param(mo49216id = 3) long j) {
