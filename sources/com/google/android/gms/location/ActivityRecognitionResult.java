...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(mo49216id = 1) List<DetectedActivity> list, @SafeParcelable.Param(mo49216id = 2) long j, @SafeParcelable.Param(mo49216id = 3) long j2, @SafeParcelable.Param(mo49216id = 4) int i, @SafeParcelable.Param(mo49216id = 5) Bundle bundle) {
        boolean z = true;
