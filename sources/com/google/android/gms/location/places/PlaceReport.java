...
public class PlaceReport extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getTag", mo49213id = 3)
    private final String tag;
    @SafeParcelable.VersionField(mo49219id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getPlaceId", mo49213id = 2)
    private final String zza;
    @SafeParcelable.Field(getter = "getSource", mo49213id = 4)
    private final String zzb;

    @SafeParcelable.Constructor
    public PlaceReport(@SafeParcelable.Param(mo49216id = 1) int i, @SafeParcelable.Param(mo49216id = 2) String str, @SafeParcelable.Param(mo49216id = 3) String str2, @SafeParcelable.Param(mo49216id = 4) String str3) {
        this.versionCode = i;
        this.zza = str;
        this.tag = str2;
        this.zzb = str3;
