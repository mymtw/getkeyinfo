...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationResult.DEFAULT_LOCATIONS", getter = "getLocations", mo49213id = 1)
    private final List<Location> zzbc;

    @SafeParcelable.Constructor
    public LocationResult(@SafeParcelable.Param(mo49216id = 1) List<Location> list) {
        this.zzbc = list;
    }
    ...
    public final String toString() {
        ...
        return C13983i.m21492k(valueOf.length() + 27, "LocationResult[locations: ", valueOf, "]");
    }
