...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(C0072d.m200g(37, "Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        throw new ParseException(C0023f.m107h(54, "Size read is invalid start=", dataPosition, " end=", i), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            ...
            sb.append(" got ");
            sb.append(i2);
            throw new ParseException(C0070b.m184f(sb, " (0x", hexString, ")"), parcel);
        }
    }
