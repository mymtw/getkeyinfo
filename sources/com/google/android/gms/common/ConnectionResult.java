...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo49213id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getResolution", mo49213id = 3)
    private final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", mo49213id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(mo49216id = 1) int i, @SafeParcelable.Param(mo49216id = 2) int i2, @SafeParcelable.Param(mo49216id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo49216id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
