...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo49213id = 1)
    private final int zzc;
    @SafeParcelable.Field(getter = "getStatusMessage", mo49213id = 2)
    private final String zzd;
    @SafeParcelable.Field(getter = "getPendingIntent", mo49213id = 3)
    private final PendingIntent zze;
    @SafeParcelable.Field(getter = "getConnectionResult", mo49213id = 4)
    ...
    @KeepForSdk
    public Status(@SafeParcelable.Param(mo49216id = 1000) int i, @SafeParcelable.Param(mo49216id = 1) int i2, @SafeParcelable.Param(mo49216id = 2) String str, @SafeParcelable.Param(mo49216id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo49216id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
