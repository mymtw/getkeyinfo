...
final class zzm {
    ...
    public static zzw zza(String str, zzi zzi, boolean z, boolean z2) {
    ...
    public static /* synthetic */ String zzc(boolean z, String str, zzi zzi) throws Exception {
    ...
    private static void zzg() throws DynamiteModule.LoadingException {
        if (zze == null) {
            ...
            synchronized (zzf) {
                if (zze == null) {
                    zze = zzae.zzb(DynamiteModule.m22901c(zzg, DynamiteModule.f32576d, "com.google.android.gms.googlecertificates").mo49525b("com.google.android.gms.common.GoogleCertificatesImpl"));
                }
            }
        }
    }
