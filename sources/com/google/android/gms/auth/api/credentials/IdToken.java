...
public final class IdToken extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getIdToken", mo49213id = 2)
    private final String zzak;
    @SafeParcelable.Field(getter = "getAccountType", mo49213id = 1)
    private final String zzr;

    @SafeParcelable.Constructor
    public IdToken(@SafeParcelable.Param(mo49216id = 1) String str, @SafeParcelable.Param(mo49216id = 2) String str2) {
