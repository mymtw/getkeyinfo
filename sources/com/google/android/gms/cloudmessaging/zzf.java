...
import p604kj.C18106k;

public final /* synthetic */ class zzf implements Handler.Callback {
    public final /* synthetic */ C18106k zza;

    public /* synthetic */ zzf(C18106k kVar) {
        this.zza = kVar;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0060, code lost:
        r2.mo69647c(new com.google.android.gms.cloudmessaging.zzq(4, "Not supported by GmsCore", (java.lang.Throwable) null));
     */
    ...
    public final boolean handleMessage(android.os.Message r5) {
        ...
        L_0x0025:
            monitor-enter(r0)
            android.util.SparseArray<kj.n<?>> r2 = r0.f39539f     // Catch:{ all -> 0x0072 }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x0072 }
            kj.n r2 = (p604kj.C18109n) r2     // Catch:{ all -> 0x0072 }
            ...
            goto L_0x0070
        L_0x004a:
            android.util.SparseArray<kj.n<?>> r3 = r0.f39539f     // Catch:{ all -> 0x0072 }
            r3.remove(r1)     // Catch:{ all -> 0x0072 }
            r0.mo69641c()     // Catch:{ all -> 0x0072 }
            monitor-exit(r0)     // Catch:{ all -> 0x0072 }
