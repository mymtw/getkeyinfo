...
public abstract class NetworkConnectionInfo {
    ...
    public static abstract class C6502a {
        public abstract NetworkConnectionInfo build();

        public abstract C6502a setMobileSubtype(MobileSubtype mobileSubtype);

        public abstract C6502a setNetworkType(NetworkType networkType);
    }

    public static C6502a builder() {
