...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = 2132018672;
    ...
    private void initBackground(Context context) {
        ...
        if (background == null || (background instanceof ColorDrawable)) {
            ...
            materialShapeDrawable.setElevation(C2364y.C2373i.m5262i(this));
            C2364y.C2368d.m5227q(this, materialShapeDrawable);
        }
    }
    ...
    private void maybeCenterTitleViews() {
        if (this.titleCentered || this.subtitleCentered) {
            TextView f0 = C0761x.m1719f0(this, getTitle());
            TextView f02 = C0761x.m1719f0(this, getSubtitle());
            if (f0 != null || f02 != null) {
                Pair<Integer, Integer> calculateTitleBoundLimits = calculateTitleBoundLimits(f0, f02);
                if (this.titleCentered && f0 != null) {
                    layoutTitleCenteredHorizontally(f0, calculateTitleBoundLimits);
                }
                if (this.subtitleCentered && f02 != null) {
                    layoutTitleCenteredHorizontally(f02, calculateTitleBoundLimits);
                }
            }
        }
    }
