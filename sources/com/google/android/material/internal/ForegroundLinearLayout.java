...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.foregroundBoundsChanged = false;
        TypedArray d = C15367g.m24957d(context, attributeSet, C18161c.f39718w, i, 0, new int[0]);
        this.foregroundGravity = d.getInt(1, this.foregroundGravity);
        Drawable drawable = d.getDrawable(0);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = d.getBoolean(2, true);
        d.recycle();
    }
}
