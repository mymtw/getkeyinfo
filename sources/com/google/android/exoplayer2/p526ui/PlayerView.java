...
public class PlayerView extends FrameLayout {
    ...
    private final C14397a componentListener;
    ...
    private PlayerControlView.C14396c controllerVisibilityListener;
    ...
    public final class C14397a implements C17884a1.C17888d, View.OnLayoutChangeListener, View.OnClickListener, PlayerControlView.C14396c {

        /* renamed from: b */
        public final C17939k1.C17941b f32412b = new C17939k1.C17941b();

        /* renamed from: c */
        public Object f32413c;
        ...
        public final void onTracksChanged(TrackGroupArray trackGroupArray, C18887e eVar) {
            C17884a1 access$700 = PlayerView.this.player;
            access$700.getClass();
            C17939k1 r = access$700.mo69338r();
            if (r.mo69481p()) {
                this.f32413c = null;
            } else if (!access$700.mo69337q().isEmpty()) {
                this.f32413c = r.mo47630f(access$700.mo69300A(), this.f32412b, true).f39099b;
            } else {
                Object obj = this.f32413c;
                if (obj != null) {
                    int b = r.mo47698b(obj);
                    if (b == -1 || access$700.mo69327j() != r.mo47630f(b, this.f32412b, false).f39100c) {
                        this.f32413c = null;
                    } else {
                        return;
                    }
    ...
    private boolean shouldShowControllerIndefinitely() {
        ...
        return this.controllerAutoShow && (playbackState == 1 || playbackState == 4 || !this.player.mo69348x());
    }

    public static void switchTargetView(C17884a1 a1Var, PlayerView playerView, PlayerView playerView2) {
        if (playerView != playerView2) {
            if (playerView2 != null) {
                playerView2.setPlayer(a1Var);
            }
            if (playerView != null) {
                playerView.setPlayer((C17884a1) null);
            }
        }
    }
    ...
    public void setControllerVisibilityListener(PlayerControlView.C14396c cVar) {
        C14075p.m21696h(this.controller);
        PlayerControlView.C14396c cVar2 = this.controllerVisibilityListener;
        if (cVar2 != cVar) {
            if (cVar2 != null) {
                this.controller.removeVisibilityListener(cVar2);
            }
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C19382n.f43265o, 0, 0);
            try {
        ...
        if (i2 != 0) {
            ...
            this.defaultArtwork = C8184a.C8187c.m16466b(context3, i2);
        }
        ...
        this.controllerShowTimeoutMs = playerControlView3 != null ? z2 : z8 ? 1 : 0;
        this.controllerHideOnTouch = z6;
        this.controllerAutoShow = z9;
        this.controllerHideDuringAds = z5;
        this.useController = (!z || playerControlView3 == null) ? z8 : true;
        hideController();
        updateContentDescription();
