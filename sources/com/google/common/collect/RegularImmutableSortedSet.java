...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    public static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<>(ImmutableList.m25826of(), Ordering.natural());
    ...
    public boolean containsAll(Collection<?> collection) {
        ...
        if (!C14088a.m21786n(collection, comparator()) || collection.size() <= 1) {
    ...
    public boolean equals(@org.checkerframework.checker.nullness.compatqual.NullableDecl java.lang.Object r6) {
        ...
        L_0x001e:
            ...
            boolean r1 = p514bk.C14088a.m21786n(r6, r1)
            if (r1 == 0) goto L_0x0047
            java.util.Iterator r6 = r6.iterator()
            com.google.common.collect.f2 r1 = r5.iterator()     // Catch:{ ClassCastException | NoSuchElementException -> 0x0046 }
        L_0x002e:
