...
final class NioByteString extends ByteString.LeafByteString {
    ...
    /* renamed from: c */
    public final ByteBuffer mo59789c(int i, int i2) {
    ...
    public boolean isValidUtf8() {
        ...
        return Utf8.f37176a.mo59817e(0, byteBuffer.position(), byteBuffer.remaining(), byteBuffer) == 0;
    }

    public C16900i newCodedInput() {
        ByteBuffer byteBuffer = this.buffer;
        if (byteBuffer.hasArray()) {
            return C16900i.m28229c(byteBuffer.array(), byteBuffer.position() + byteBuffer.arrayOffset(), byteBuffer.remaining(), true);
        } else if (byteBuffer.isDirect() && C16889f1.f37213d) {
            return new C16900i.C16903c(byteBuffer);
        } else {
            int remaining = byteBuffer.remaining();
            byte[] bArr = new byte[remaining];
            byteBuffer.duplicate().get(bArr);
            return C16900i.m28229c(bArr, 0, remaining, true);
        }
    }

    public InputStream newInput() {
        return new C16843a(this);
    }
    ...
    public int partialIsValidUtf8(int i, int i2, int i3) {
        ByteBuffer byteBuffer = this.buffer;
        return Utf8.f37176a.mo59817e(i, i2, i3 + i2, byteBuffer);
    }
    ...
    public ByteString substring(int i, int i2) {
        try {
            return new NioByteString(mo59789c(i, i2));
        } catch (ArrayIndexOutOfBoundsException e) {
            throw e;
        } catch (IndexOutOfBoundsException e2) {
            throw new ArrayIndexOutOfBoundsException(e2.getMessage());
    ...
    public void writeToInternal(java.io.OutputStream r9, int r10, int r11) throws java.io.IOException {
        ...
        L_0x0020:
            int r11 = r11 + r10
            java.nio.ByteBuffer r10 = r8.mo59789c(r10, r11)
            java.lang.ThreadLocal<java.lang.ref.SoftReference<byte[]>> r11 = com.google.protobuf.C16895g.f37219a
            ...
            goto L_0x00be
        L_0x0047:
            long r0 = com.google.protobuf.C16895g.f37221c     // Catch:{ all -> 0x00c2 }
            r2 = 0
            ...
            java.lang.Class<?> r2 = com.google.protobuf.C16895g.f37220b     // Catch:{ all -> 0x00c2 }
            boolean r2 = r2.isInstance(r9)     // Catch:{ all -> 0x00c2 }
            if (r2 == 0) goto L_0x0069
            java.lang.Object r0 = com.google.protobuf.C16889f1.m28157o(r0, r9)     // Catch:{ ClassCastException -> 0x0061 }
        ...
        L_0x006a:
            ...
            java.lang.ThreadLocal<java.lang.ref.SoftReference<byte[]>> r1 = com.google.protobuf.C16895g.f37219a     // Catch:{ all -> 0x00c2 }
    ...
    public class C16843a extends InputStream {

        /* renamed from: b */
        public final ByteBuffer f37161b;

        public C16843a(NioByteString nioByteString) {
            this.f37161b = nioByteString.buffer.slice();
        }

        public final int available() throws IOException {
            return this.f37161b.remaining();
        }
        ...
        public final int read() throws IOException {
            if (!this.f37161b.hasRemaining()) {
                return -1;
            }
            return this.f37161b.get() & 255;
        }
        ...
        public final int read(byte[] bArr, int i, int i2) throws IOException {
            ...
            int min = Math.min(i2, this.f37161b.remaining());
            this.f37161b.get(bArr, i, min);
            return min;
        }
    }

    public void writeTo(C16898h hVar) throws IOException {
        hVar.mo59735b(this.buffer.slice());
    }
}
