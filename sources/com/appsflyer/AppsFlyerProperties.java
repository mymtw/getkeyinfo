...
public class AppsFlyerProperties {
    ...
    public String getReferrer(Context context) {
        ...
        return C4986ag.AFInAppEventParameterName(context).getString("referrer", (String) null);
    }
    ...
    public synchronized void loadProperties(android.content.Context r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r0 = r5.AFInAppEventType()     // Catch:{ all -> 0x0075 }
            if (r0 == 0) goto L_0x0009
            monitor-exit(r5)
            return
        L_0x0009:
            android.content.SharedPreferences r6 = com.appsflyer.internal.C4986ag.AFInAppEventParameterName((android.content.Context) r6)     // Catch:{ all -> 0x0075 }
            ...
            com.appsflyer.AFLogger.valueOf(r1)     // Catch:{ all -> 0x0075 }
        ...
        L_0x0056:
            r6 = 1
            r5.init = r6     // Catch:{ JSONException -> 0x005a }
            goto L_0x0060
        L_0x005a:
            r6 = move-exception
            java.lang.String r0 = "Failed loading properties"
            com.appsflyer.AFLogger.AFKeystoreWrapper((java.lang.String) r0, (java.lang.Throwable) r6)     // Catch:{ all -> 0x0075 }
        L_0x0060:
            ...
            boolean r0 = r5.init     // Catch:{ all -> 0x0075 }
            r6.append(r0)     // Catch:{ all -> 0x0075 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0075 }
            com.appsflyer.AFLogger.valueOf(r6)     // Catch:{ all -> 0x0075 }
        L_0x0073:
            monitor-exit(r5)
            return
        L_0x0075:
