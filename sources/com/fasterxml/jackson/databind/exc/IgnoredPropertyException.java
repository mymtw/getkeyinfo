...
public class IgnoredPropertyException extends PropertyBindingException {
    ...
    public static IgnoredPropertyException from(JsonParser jsonParser, Object obj, String str, Collection<Object> collection) {
        ...
        IgnoredPropertyException ignoredPropertyException = new IgnoredPropertyException(jsonParser, String.format("Ignored field \"%s\" (class %s) encountered; mapper configured not to allow this", new Object[]{str, cls.getName()}), jsonParser.getCurrentLocation(), cls, str, collection);
