...
public class BeanDeserializer extends BeanDeserializerBase {
    ...
    public static /* synthetic */ class C12520a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f27657a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.deser.BeanDeserializer.C12520a.<clinit>():void");
        }
    }

    /* renamed from: com.fasterxml.jackson.databind.deser.BeanDeserializer$b */
    public static class C12521b extends ReadableObjectId.Referring {

        /* renamed from: a */
        public final DeserializationContext f27658a;

        /* renamed from: b */
        public final SettableBeanProperty f27659b;

        /* renamed from: c */
        public Object f27660c;

        public C12521b(DeserializationContext deserializationContext, UnresolvedForwardReference unresolvedForwardReference, JavaType javaType, SettableBeanProperty settableBeanProperty) {
            super(unresolvedForwardReference, javaType);
            this.f27658a = deserializationContext;
            this.f27659b = settableBeanProperty;
        }

        public final void handleResolvedForwardReference(Object obj, Object obj2) throws IOException {
            if (this.f27660c == null) {
                DeserializationContext deserializationContext = this.f27658a;
                SettableBeanProperty settableBeanProperty = this.f27659b;
                deserializationContext.reportInputMismatch((BeanProperty) settableBeanProperty, "Cannot resolve ObjectId forward reference using property '%s' (of type %s): Bean not yet resolved", settableBeanProperty.getName(), this.f27659b.getDeclaringClass().getName());
            }
            this.f27659b.set(this.f27660c, obj2);
        }
    }
    ...
    private C12521b handleUnresolvedReference(DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty, PropertyValueBuffer propertyValueBuffer, UnresolvedForwardReference unresolvedForwardReference) throws JsonMappingException {
        C12521b bVar = new C12521b(deserializationContext, unresolvedForwardReference, settableBeanProperty.getType(), settableBeanProperty);
        unresolvedForwardReference.getRoid().appendReferring(bVar);
        return bVar;
    }
    ...
    public final Object _deserializeOther(JsonParser jsonParser, DeserializationContext deserializationContext, JsonToken jsonToken) throws IOException {
        if (jsonToken != null) {
            switch (C12520a.f27657a[jsonToken.ordinal()]) {
                case 1:
    ...
    public Object _deserializeUsingPropertyBased(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        ArrayList<C12521b> arrayList = null;
                ...
                if (findCreatorProperty == null) {
                    ...
                    if (find != null) {
                        try {
                            ...
                            C12521b handleUnresolvedReference = handleUnresolvedReference(deserializationContext, find, startBuilding, e);
                            if (arrayList == null) {
