...
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    public static final class StringKD extends StdKeyDeserializer {
        ...
        /* renamed from: b */
        public static final StringKD f27684b = new StringKD(String.class);

        /* renamed from: c */
        public static final StringKD f27685c = new StringKD(Object.class);
        private static final long serialVersionUID = 1;
        ...
        public static StringKD forType(Class<?> cls) {
            return cls == String.class ? f27684b : cls == Object.class ? f27685c : new StringKD(cls);
        }
    ...
    public Object _parse(String str, DeserializationContext deserializationContext) throws Exception {
        switch (this._kind) {
            ...
            default:
                StringBuilder h = C0072d.m201h("Internal error: unknown key type ");
                h.append(this._keyClass);
