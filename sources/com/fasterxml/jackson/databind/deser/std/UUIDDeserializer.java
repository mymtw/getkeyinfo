...
public class UUIDDeserializer extends FromStringDeserializer<UUID> {
    ...
    private UUID _fromBytes(byte[] bArr, DeserializationContext deserializationContext) throws JsonMappingException {
        ...
        throw InvalidFormatException.from(deserializationContext.getParser(), C0071c.m191c(C0072d.m201h("Can only construct UUIDs from byte[16]; got "), bArr.length, " bytes"), bArr, handledType());
    }
