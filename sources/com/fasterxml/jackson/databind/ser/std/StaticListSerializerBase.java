...
public abstract class StaticListSerializerBase<T extends Collection<?>> extends StdSerializer<T> implements ContextualSerializer {
    ...
    public com.fasterxml.jackson.databind.JsonSerializer<?> createContextual(com.fasterxml.jackson.databind.SerializerProvider r6, com.fasterxml.jackson.databind.BeanProperty r7) throws com.fasterxml.jackson.databind.JsonMappingException {
        ...
        L_0x002d:
            ...
            com.fasterxml.jackson.databind.JsonSerializer r2 = r6.findContentValueSerializer((java.lang.Class<?>) r0, (com.fasterxml.jackson.databind.BeanProperty) r7)
        L_0x0037:
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
        return createSchemaNode("array", true).set(ResponseConstants.ITEMS, contentSchema());
    }
