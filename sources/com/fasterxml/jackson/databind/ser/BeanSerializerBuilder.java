...
public class BeanSerializerBuilder {
    ...
    public List<BeanPropertyWriter> _properties = Collections.emptyList();
    ...
    public void setTypeId(AnnotatedMember annotatedMember) {
        ...
        StringBuilder h = C0072d.m201h("Multiple type ids specified with ");
        h.append(this._typeId);
        h.append(" and ");
        h.append(annotatedMember);
