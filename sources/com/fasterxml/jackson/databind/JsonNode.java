...
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    public static /* synthetic */ class C12513a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f27648a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f27648a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.JsonNode.C12513a.<clinit>():void");
        }
    }
    ...
    public double asDouble() {
        return asDouble(ShadowDrawableWrapper.COS_45);
    }
    ...
    public final boolean isValueNode() {
        int i = C12513a.f27648a[getNodeType().ordinal()];
    ...
    public <T extends JsonNode> T with(String str) {
        StringBuilder h = C0072d.m201h("JsonNode not of type ObjectNode (but ");
        h.append(getClass().getName());
        h.append("), cannot call with() on it");
    ...
    public <T extends JsonNode> T withArray(String str) {
        StringBuilder h = C0072d.m201h("JsonNode not of type ObjectNode (but ");
        h.append(getClass().getName());
        h.append("), cannot call withArray() on it");
        throw new UnsupportedOperationException(h.toString());
    }
    ...
    /* renamed from: at */
    public final JsonNode m20261at(JsonPointer jsonPointer) {
        ...
        return _at.mo41287at(jsonPointer.tail());
    }
    ...
    /* renamed from: at */
    public final JsonNode m20262at(String str) {
        return mo41287at(JsonPointer.compile(str));
    }
}
