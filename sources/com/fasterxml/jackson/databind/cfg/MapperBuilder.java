...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    /* renamed from: com.fasterxml.jackson.databind.cfg.MapperBuilder$a */
    public static class C12518a implements PrivilegedAction<ServiceLoader<T>> {

        /* renamed from: a */
        public final /* synthetic */ ClassLoader f27654a;

        /* renamed from: b */
        public final /* synthetic */ Class f27655b;

        public C12518a(Class cls, ClassLoader classLoader) {
            this.f27654a = classLoader;
            this.f27655b = cls;
        }

        public final Object run() {
            ClassLoader classLoader = this.f27654a;
            return classLoader == null ? ServiceLoader.load(this.f27655b) : ServiceLoader.load(this.f27655b, classLoader);
        }
    }
    ...
    private static <T> ServiceLoader<T> secureGetServiceLoader(Class<T> cls, ClassLoader classLoader) {
        return System.getSecurityManager() == null ? classLoader == null ? ServiceLoader.load(cls) : ServiceLoader.load(cls, classLoader) : (ServiceLoader) AccessController.doPrivileged(new C12518a(cls, classLoader));
    }
    ...
    public B activateDefaultTyping(PolymorphicTypeValidator polymorphicTypeValidator, ObjectMapper.DefaultTyping defaultTyping, JsonTypeInfo.C12506As as) {
