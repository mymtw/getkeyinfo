...
public class UTF32Reader extends Reader {
    ...
    /* renamed from: NC */
    public static final char f27621NC = 0;
    ...
    private void reportBounds(char[] cArr, int i, int i2) throws IOException {
        throw new ArrayIndexOutOfBoundsException(C0071c.m191c(C0472h.m1244g("read(buf,", i, ",", i2, "), cbuf["), cArr.length, "]"));
    }

    private void reportInvalid(int i, int i2, String str) throws IOException {
        StringBuilder h = C0072d.m201h("Invalid UTF-32 character 0x");
        h.append(Integer.toHexString(i));
        h.append(str);
        h.append(" at char #");
        h.append(this._charCount + i2);
        h.append(", byte #");
        throw new CharConversionException(C0071c.m191c(h, (this._byteCount + this._ptr) - 1, ")"));
    }
    ...
    private void reportUnexpectedEOF(int i, int i2) throws IOException {
        ...
        StringBuilder g = C0472h.m1244g("Unexpected EOF in the middle of a 4-byte UTF-32 char: got ", i, ", needed ", i2, ", at char #");
        g.append(i4);
        g.append(", byte #");
        g.append(i3);
        g.append(")");
    ...
    public int read(char[] r11, int r12, int r13) throws java.io.IOException {
        ...
        L_0x00d1:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p333io.UTF32Reader.read(char[], int, int):int");
    }
}
