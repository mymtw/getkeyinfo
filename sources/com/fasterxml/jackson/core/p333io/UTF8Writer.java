...
public final class UTF8Writer extends Writer {
    ...
    public static String illegalSurrogateDesc(int i) {
        if (i > 1114111) {
            StringBuilder h = C0072d.m201h("Illegal character point (0x");
            h.append(Integer.toHexString(i));
            h.append(") to output; max is 0x10FFFF as per RFC 4627");
            return h.toString();
        } else if (i < 55296) {
            StringBuilder h2 = C0072d.m201h("Illegal character point (0x");
            h2.append(Integer.toHexString(i));
            h2.append(") to output");
            return h2.toString();
        } else if (i <= 56319) {
            StringBuilder h3 = C0072d.m201h("Unmatched first part of surrogate pair (0x");
            h3.append(Integer.toHexString(i));
            h3.append(")");
            return h3.toString();
        } else {
            StringBuilder h4 = C0072d.m201h("Unmatched second part of surrogate pair (0x");
        ...
        if (i2 >= 2) {
            ...
            while (r9 < i5) {
                ...
                if (c < 2048) {
                    ...
                    i3 = i11 + 1;
                    bArr[i11] = (byte) ((c & RFC1522Codec.SEP) | 128);
                    r9 = i6;
        ...
        if (i2 >= 2) {
            ...
            while (r9 < i5) {
                ...
                if (charAt < 2048) {
                    ...
                    i3 = i11 + 1;
                    bArr[i11] = (byte) ((charAt & RFC1522Codec.SEP) | 128);
                    r9 = i6;
                    ...
                    bArr[i13] = (byte) ((charAt & RFC1522Codec.SEP) | 128);
                    r9 = i6;
                    i3 = i13 + 1;
                } else {
                    if (charAt > 56319) {
