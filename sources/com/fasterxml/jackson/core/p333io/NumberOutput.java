...
public final class NumberOutput {
    ...
    private static final String[] sSmallIntStrs = {"0", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, "2", "3", "4", "5", "6", "7", "8", "9", "10"};
    private static final String[] sSmallIntStrs2 = {EditableListing.LISTING_ID_DEVICE_DRAFT, "-2", "-3", "-4", "-5", "-6", "-7", "-8", "-9", "-10"};
