...
public final class MergedStream extends InputStream {
    ...
    public int available() throws IOException {
        return this.f27620_b != null ? this._end - this._ptr : this._in.available();
    }
    ...
    public void mark(int i) {
        if (this.f27620_b == null) {
            this._in.mark(i);
        }
    }

    public boolean markSupported() {
        return this.f27620_b == null && this._in.markSupported();
    }
