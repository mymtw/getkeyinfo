...
public abstract class JsonParser implements Closeable, Versioned {
    ...
    public void _reportUnsupportedOperation() {
        StringBuilder h = C0072d.m201h("Operation not supported by parser of type ");
    ...
    public double getValueAsDouble() throws IOException {
        return getValueAsDouble(ShadowDrawableWrapper.COS_45);
    }
    ...
    public void setSchema(FormatSchema formatSchema) {
        StringBuilder h = C0072d.m201h("Parser of type ");
        h.append(getClass().getName());
        h.append(" does not support schema of type '");
        h.append(formatSchema.getSchemaType());
        h.append("'");
        throw new UnsupportedOperationException(h.toString());
    }
