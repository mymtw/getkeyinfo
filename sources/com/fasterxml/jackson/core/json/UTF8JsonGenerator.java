...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
            ...
            if (c <= 127) {
                ...
                if (i7 == 0) {
                    ...
                    if (escapeSequence == null) {
                        StringBuilder h = C0072d.m201h("Invalid custom escape definitions; custom escape not found for character code 0x");
                        h.append(Integer.toHexString(c));
                        h.append(", although was supposed to have one");
                        _reportError(h.toString());
                    }
                    i3 = _writeCustomEscape(bArr, i4, escapeSequence, i2 - i6);
                } else {
                    i3 = _writeGenericEscape(c, i4);
                }
            } else if (c > i5) {
                i3 = _writeGenericEscape(c, i4);
            } else {
                ...
                if (escapeSequence2 != null) {
                    i3 = _writeCustomEscape(bArr, i4, escapeSequence2, i2 - i6);
                } else if (c <= 2047) {
                    int i9 = i4 + 1;
                    bArr[i4] = (byte) ((c >> 6) | 192);
                    i4 = i9 + 1;
                    bArr[i9] = (byte) ((c & RFC1522Codec.SEP) | 128);
                    i = i6;
                } else {
                    i3 = _outputMultiByteChar(c, i4);
                }
            }
            i4 = i3;
            i = i6;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x000e, code lost:
        ...
        r1[r2] = (byte) ((r0 >> 6) | 192);
        r5._outputTail = r3 + 1;
        r1[r3] = (byte) ((r0 & org.apache.commons.codec.net.RFC1522Codec.SEP) | 128);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0020, code lost:
        ...
        r1[r4] = (byte) ((r9 >> 6) | 192);
        r7._outputTail = r5 + 1;
        r1[r5] = (byte) ((r9 & org.apache.commons.codec.net.RFC1522Codec.SEP) | 128);
        r9 = r2;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public final void writeEndArray() throws IOException {
        if (!this._writeContext.inArray()) {
            StringBuilder h = C0072d.m201h("Current context not Array but ");
            h.append(this._writeContext.typeDesc());
            _reportError(h.toString());
        }
    ...
    public final void writeEndObject() throws IOException {
        if (!this._writeContext.inObject()) {
            StringBuilder h = C0072d.m201h("Current context not Object but ");
            h.append(this._writeContext.typeDesc());
            _reportError(h.toString());
        }
        PrettyPrinter prettyPrinter = this._cfgPrettyPrinter;
    ...
    public void writeString(Reader reader, int i) throws IOException {
        ...
        int i2 = i >= 0 ? i : Api.BaseClientBuilder.API_PRIORITY_OTHER;
        char[] cArr = this._charBuffer;
        if (this._outputTail >= this._outputEnd) {
            _flushBuffer();
        }
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                if (i6 == 0) {
                    ...
                    i3 = _writeGenericEscape(charAt, i4);
                }
            } else if (charAt <= 2047) {
                int i8 = i4 + 1;
                bArr[i4] = (byte) ((charAt >> 6) | 192);
                i4 = i8 + 1;
                bArr[i8] = (byte) ((charAt & RFC1522Codec.SEP) | 128);
                i = i5;
            } else {
                i3 = _outputMultiByteChar(charAt, i4);
            }
            i4 = i3;
            i = i5;
        }
    ...
    private final void _writeStringSegmentASCII2(String str, int i, int i2) throws IOException {
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                bArr[i4] = (byte) ((charAt >> 6) | 192);
                i4 = i9 + 1;
                bArr[i9] = (byte) ((charAt & RFC1522Codec.SEP) | 128);
                i = i6;
            } else {
                i3 = _outputMultiByteChar(charAt, i4);
            }
        ...
        while (i < i2) {
            ...
            if (charAt <= 127) {
                ...
                if (i7 == 0) {
                    ...
                    if (escapeSequence == null) {
                        StringBuilder h = C0072d.m201h("Invalid custom escape definitions; custom escape not found for character code 0x");
                        h.append(Integer.toHexString(charAt));
                        h.append(", although was supposed to have one");
                        _reportError(h.toString());
                    }
                    i3 = _writeCustomEscape(bArr, i4, escapeSequence, i2 - i6);
