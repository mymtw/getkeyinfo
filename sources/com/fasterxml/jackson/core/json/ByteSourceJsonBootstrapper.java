...
import com.fasterxml.jackson.core.p333io.UTF32Reader;
...
public final class ByteSourceJsonBootstrapper {
    ...
    private void reportWeirdUCS4(String str) throws IOException {
        throw new CharConversionException(C0048b.m163a("Unsupported UCS-4 endianness (", str, ") detected"));
    }
    ...
    public static int skipUTF8BOM(DataInput dataInput) throws IOException {
        ...
        if (readUnsignedByte2 == 187) {
            ...
            StringBuilder h = C0072d.m201h("Unexpected byte 0x");
            h.append(Integer.toHexString(readUnsignedByte3));
            h.append(" following 0xEF 0xBB; should get 0xBF as part of UTF-8 BOM");
            throw new IOException(h.toString());
        }
        StringBuilder h2 = C0072d.m201h("Unexpected byte 0x");
        h2.append(Integer.toHexString(readUnsignedByte2));
        h2.append(" following 0xEF; should get 0xBB as part of UTF-8 BOM");
