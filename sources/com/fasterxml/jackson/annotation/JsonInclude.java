...
public @interface JsonInclude {
    ...
    public static class Value implements JacksonAnnotationValue<JsonInclude>, Serializable {
        ...
        public String toString() {
            StringBuilder g = C0069a.m176g(80, "JsonInclude.Value(value=");
            g.append(this._valueInclusion);
            g.append(",content=");
            g.append(this._contentInclusion);
            if (this._valueFilter != null) {
                g.append(",valueFilter=");
                g.append(this._valueFilter.getName());
                g.append(".class");
            }
            if (this._contentFilter != null) {
                g.append(",contentFilter=");
                g.append(this._contentFilter.getName());
                g.append(".class");
            }
            g.append(')');
            return g.toString();
