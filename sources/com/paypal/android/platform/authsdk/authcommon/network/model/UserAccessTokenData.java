...
public final class UserAccessTokenData {
    ...
    public UserAccessTokenData(String str, String str2, String str3, int i, String str4, String str5, String str6) {
    ...
    public static /* synthetic */ UserAccessTokenData copy$default(UserAccessTokenData userAccessTokenData, String str, String str2, String str3, int i, String str4, String str5, String str6, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        String str8 = str3;
        if ((i2 & 8) != 0) {
            i = userAccessTokenData.expirationInSeconds;
        }
        int i3 = i;
        if ((i2 & 16) != 0) {
        ...
        return userAccessTokenData.copy(str, str7, str8, i3, str9, str10, str6);
    }
    ...
    public final UserAccessTokenData copy(String str, String str2, String str3, int i, String str4, String str5, String str6) {
        C19383o.m32797g(str, "tokenType");
        C19383o.m32797g(str2, "tokenValue");
        C19383o.m32797g(str3, "expires");
        C19383o.m32797g(str4, "authenticationTier");
        ...
        return new UserAccessTokenData(str, str2, str3, i, str4, str5, str7);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return C19383o.m32792b(this.tokenType, userAccessTokenData.tokenType) && C19383o.m32792b(this.tokenValue, userAccessTokenData.tokenValue) && C19383o.m32792b(this.expires, userAccessTokenData.expires) && this.expirationInSeconds == userAccessTokenData.expirationInSeconds && C19383o.m32792b(this.authenticationTier, userAccessTokenData.authenticationTier) && C19383o.m32792b(this.authenticationType, userAccessTokenData.authenticationType) && C19383o.m32792b(this.objectType, userAccessTokenData.objectType);
    }
    ...
    public String toString() {
        ...
        StringBuilder f = C0388a.m1050f("UserAccessTokenData(tokenType=", str, ", tokenValue=", str2, ", expires=");
        f.append(str3);
