...
@C19060c(mo70540c = "com.paypal.android.platform.authsdk.otplogin.data.OtpLoginRepositoryImpl$generateChallenge$2", mo70541f = "OtpLoginRepositoryImpl.kt", mo70542l = {30}, mo70543m = "invokeSuspend")
public final class OtpLoginRepositoryImpl$generateChallenge$2 extends SuspendLambda implements C19861p<C19525d0, C19340c<? super ResultStatus<GenerateChallengeData>>, Object> {
    public final /* synthetic */ OTPLoginData $otpLoginData;
    public int label;
    public final /* synthetic */ OtpLoginRepositoryImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OtpLoginRepositoryImpl$generateChallenge$2(OtpLoginRepositoryImpl otpLoginRepositoryImpl, OTPLoginData oTPLoginData, C19340c<? super OtpLoginRepositoryImpl$generateChallenge$2> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(C19525d0 d0Var, C19340c<? super ResultStatus<GenerateChallengeData>> cVar) {
        return ((OtpLoginRepositoryImpl$generateChallenge$2) create(d0Var, cVar)).invokeSuspend(C19394m.f43287a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            C0761x.m1684O0(obj);
            GenerateChallengeAPIRequest access$generateChallengeRequestBody = this.this$0.generateChallengeRequestBody(this.$otpLoginData);
            ...
            this.label = 1;
            obj = access$getOtpLoginApiService$p.generateChallenge(buildHeaderMap, access$generateChallengeRequestBody, this);
        ...
        if (vVar.mo74384a()) {
            GenerateChallengeResponse generateChallengeResponse = (GenerateChallengeResponse) vVar.f44615b;
            ...
            if (vVar.f44614a.f44365f != 206) {
                return ResultStatus.Companion.withSuccess(GenerateChallengeResponseKt.toGenerateChallengeData(generateChallengeResponse));
            }
