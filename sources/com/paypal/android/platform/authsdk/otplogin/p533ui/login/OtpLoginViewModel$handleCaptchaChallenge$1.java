...
@C19060c(mo70540c = "com.paypal.android.platform.authsdk.otplogin.ui.login.OtpLoginViewModel$handleCaptchaChallenge$1", mo70541f = "OtpLoginViewModel.kt", mo70542l = {221}, mo70543m = "invokeSuspend")
/* renamed from: com.paypal.android.platform.authsdk.otplogin.ui.login.OtpLoginViewModel$handleCaptchaChallenge$1 */
public final class OtpLoginViewModel$handleCaptchaChallenge$1 extends SuspendLambda implements C19861p<C19525d0, C19340c<? super C19394m>, Object> {
    ...
    public OtpLoginViewModel$handleCaptchaChallenge$1(String str, CaptchaUriData captchaUriData, OtpLoginViewModel otpLoginViewModel, C19340c<? super OtpLoginViewModel$handleCaptchaChallenge$1> cVar) {
        super(2, cVar);
        this.$requestId = str;
    ...
    public final Object invoke(C19525d0 d0Var, C19340c<? super C19394m> cVar) {
        return ((OtpLoginViewModel$handleCaptchaChallenge$1) create(d0Var, cVar)).invokeSuspend(C19394m.f43287a);
    }
        ...
        if (challengeResult instanceof ChallengeResult.Completed) {
            ...
            if (error instanceof ChallengeError.Cancelled) {
                ...
                if (!(reason == null || (cause = reason.getCause()) == null || C19457k.m33019W0(cause.getMessage(), ConstantsKt.BACK_PRESS, true))) {
                    C19697g.m33468f(C19388s.m32866i0(otpLoginViewModel), (CoroutineContext) null, (CoroutineStart) null, new OtpLoginViewModel$handleCaptchaChallenge$1$1$1$1(otpLoginViewModel, challengeResult, (C19340c<? super OtpLoginViewModel$handleCaptchaChallenge$1$1$1$1>) null), 3);
                }
