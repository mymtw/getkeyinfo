...
public final class PayPalConversionRateHeaderView extends RelativeLayout implements ContentView, View.OnClickListener {
    ...
    public static final String TAG = "PayPalConversionRateHeaderView";
    ...
    static {
        Class<PayPalConversionRateHeaderView> cls = PayPalConversionRateHeaderView.class;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public PayPalConversionRateHeaderView(Context context) {
        this(context, (AttributeSet) null, 0, (Fragment) null, (PayPalConversionRateHeaderViewListener) null, 30, (DefaultConstructorMarker) null);
        C19383o.m32797g(context, ResponseConstants.CONTEXT);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public PayPalConversionRateHeaderView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0, (Fragment) null, (PayPalConversionRateHeaderViewListener) null, 28, (DefaultConstructorMarker) null);
        C19383o.m32797g(context, ResponseConstants.CONTEXT);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public PayPalConversionRateHeaderView(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, (Fragment) null, (PayPalConversionRateHeaderViewListener) null, 24, (DefaultConstructorMarker) null);
        C19383o.m32797g(context, ResponseConstants.CONTEXT);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public PayPalConversionRateHeaderView(Context context, AttributeSet attributeSet, int i, Fragment fragment2) {
        this(context, attributeSet, i, fragment2, (PayPalConversionRateHeaderViewListener) null, 16, (DefaultConstructorMarker) null);
        C19383o.m32797g(context, ResponseConstants.CONTEXT);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ PayPalConversionRateHeaderView(Context context, AttributeSet attributeSet, int i, Fragment fragment2, PayPalConversionRateHeaderViewListener payPalConversionRateHeaderViewListener, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i2 & 2) != 0 ? null : attributeSet, (i2 & 4) != 0 ? 0 : i, (i2 & 8) != 0 ? null : fragment2, (i2 & 16) != 0 ? null : payPalConversionRateHeaderViewListener);
    }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == C17165R.C17167id.conversionBackArrowImageView) {
    ...
    public PayPalConversionRateHeaderView(Context context, AttributeSet attributeSet, int i, Fragment fragment2, PayPalConversionRateHeaderViewListener payPalConversionRateHeaderViewListener) {
        ...
        if (context2 instanceof ComponentActivity) {
            ...
            View.inflate(context, C17165R.C17169layout.paypal_conversion_rate_header_layout, this);
            View findViewById = findViewById(C17165R.C17167id.conversionBackArrowImageView);
            C19383o.m32796f(findViewById, "findViewById(R.id.conversionBackArrowImageView)");
