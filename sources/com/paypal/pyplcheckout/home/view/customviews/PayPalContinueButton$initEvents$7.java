...
public final class PayPalContinueButton$initEvents$7 implements EventListener {
    public final /* synthetic */ PayPalContinueButton this$0;

    public PayPalContinueButton$initEvents$7(PayPalContinueButton payPalContinueButton) {
    ...
    public void onEvent(EventType eventType, ResultData resultData) {
        ...
        this.this$0.isInvalidShippingAddress = true;
