...
public class CircleImageView extends AppCompatImageView {
    ...
    public class OutlineProvider extends ViewOutlineProvider {
        ...
        public /* synthetic */ OutlineProvider(CircleImageView circleImageView, int i) {
            this();
        }
    ...
    static {
        Class<CircleImageView> cls = CircleImageView.class;
    }
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            ...
            String str = TAG;
            PLog.m28729e(str, "Exception HAPPENS WHILE TRYING TO CONVERT DRAWABLE TO BITMAP." + e);
            return null;
        }
    }

    private boolean inTouchableArea(float f, float f2) {
        return Math.pow((double) (f2 - this.mBorderRect.centerY()), 2.0d) + Math.pow((double) (f - this.mBorderRect.centerX()), 2.0d) <= Math.pow((double) this.mBorderRadius, 2.0d);
    }

    private void init() {
        super.setScaleType(SCALE_TYPE);
        this.mReady = true;
        setOutlineProvider(new OutlineProvider(this, 0));
    ...
    public void setCircleBackgroundColorResource(int i) {
        ...
        setCircleBackgroundColor(C8184a.C8188d.m16468a(context, i));
    }
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderWidth = 0;
        this.mCircleBackgroundColor = 0;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C17165R.styleable.CircleImageView, i, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C17165R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = obtainStyledAttributes.getColor(C17165R.styleable.CircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
        this.mBorderOverlay = obtainStyledAttributes.getBoolean(C17165R.styleable.CircleImageView_civ_border_overlay, false);
        this.mCircleBackgroundColor = obtainStyledAttributes.getColor(C17165R.styleable.CircleImageView_civ_circle_background_color, 0);
