...
public final class PayPalContinueButton$initEvents$3 implements EventListener {
    public final /* synthetic */ PayPalContinueButton this$0;

    public PayPalContinueButton$initEvents$3(PayPalContinueButton payPalContinueButton) {
    ...
    public void onEvent(EventType eventType, ResultData resultData) {
        ...
        if (resultData != null) {
            ...
            if (data != null) {
                this.this$0.setupOffer(((OfferViewStateUpdateEvent) data).getCtaText(), C17165R.string.paypal_checkout_continuestring, PEnums.TransitionName.GLOBAL_PAY_LATER_CTA_CLICKED, "global_pay_later_view", new PayPalContinueButton$initEvents$3$onEvent$1(this.this$0));
                return;
            }
