...
public final class ShippingAddressViewContentPageConfig extends ContentPage {
    public ShippingAddressViewContentPageConfig(Context context, Fragment fragment, NewShippingAddressViewListenerImpl newShippingAddressViewListenerImpl, ContentPage contentPage) {
        ...
        if (contentPage == null) {
            ...
            NewShippingAddressViewListenerImpl newShippingAddressViewListenerImpl2 = newShippingAddressViewListenerImpl;
            this.headerContentViewsList.add(new PayPalNewShippingAddressHeaderView(context2, (AttributeSet) null, 0, fragment2, newShippingAddressViewListenerImpl2, 6, (DefaultConstructorMarker) null));
            this.bodyContentViewsList.add(new PayPalNewShippingAddressSearchView(context2, (AttributeSet) null, 0, fragment2, newShippingAddressViewListenerImpl2, 6, (DefaultConstructorMarker) null));
            return;
        }
        ...
        NewShippingAddressViewListenerImpl newShippingAddressViewListenerImpl3 = newShippingAddressViewListenerImpl;
        this.headerContentViewsList = NavigationUtils.createContentViewNewInstance$default(headerContentViewsList, context3, fragment3, (UserProfileViewListenerImpl) null, (AddressBookViewListenerImpl) null, (ConversionRateViewListenerImpl) null, (RateProtectionViewListenerImpl) null, (HomeViewListenerImpl) null, (ShippingMethodsViewListenerImpl) null, (PayPalThreeDSV1ViewListenerImpl) null, newShippingAddressViewListenerImpl3, (NewShippingAddressReviewViewListenerImpl) null, (CryptoConsentViewListenerImpl) null, 7160, (Object) null);
