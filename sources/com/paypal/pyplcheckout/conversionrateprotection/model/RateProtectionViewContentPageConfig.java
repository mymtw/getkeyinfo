...
public final class RateProtectionViewContentPageConfig extends ContentPage {
    public RateProtectionViewContentPageConfig(Context context, Fragment fragment, RateProtectionViewListenerImpl rateProtectionViewListenerImpl, ContentPage contentPage) {
        ...
        if (contentPage == null) {
            ...
            RateProtectionViewListenerImpl rateProtectionViewListenerImpl2 = rateProtectionViewListenerImpl;
            this.headerContentViewsList.add(new PayPalRateProtectionHeaderView(context2, (AttributeSet) null, 0, fragment2, rateProtectionViewListenerImpl2, 6, (DefaultConstructorMarker) null));
            this.bodyContentViewsList.add(new PayPalRateProtectionInfoView(context2, (AttributeSet) null, 0, fragment2, rateProtectionViewListenerImpl2, 6, (DefaultConstructorMarker) null));
            return;
        }
        ...
        RateProtectionViewListenerImpl rateProtectionViewListenerImpl3 = rateProtectionViewListenerImpl;
        this.headerContentViewsList = NavigationUtils.createContentViewNewInstance$default(headerContentViewsList, context3, fragment3, (UserProfileViewListenerImpl) null, (AddressBookViewListenerImpl) null, (ConversionRateViewListenerImpl) null, rateProtectionViewListenerImpl3, (HomeViewListenerImpl) null, (ShippingMethodsViewListenerImpl) null, (PayPalThreeDSV1ViewListenerImpl) null, (NewShippingAddressViewListenerImpl) null, (NewShippingAddressReviewViewListenerImpl) null, (CryptoConsentViewListenerImpl) null, 8120, (Object) null);
