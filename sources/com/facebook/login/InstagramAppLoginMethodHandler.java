...
public final class InstagramAppLoginMethodHandler extends NativeAppLoginMethodHandler {
    ...
    public int tryAuthorize(LoginClient.Request request) {
        ...
        if (C13080a.m20762b(cls2)) {
            ...
            try {
                intent = C12851e0.m20513n(activity, C12851e0.f28346e.mo45630c(new C12851e0.C12854c(), applicationId, permissions, e2e, hasPublishPermission, defaultAudience, clientState, authType, false, messengerPageId, resetMessengerState, LoginTargetApp.INSTAGRAM, isFamilyLogin, shouldSkipAccountDeduplication, ""));
            } catch (Throwable th2) {
                th = th2;
                C13080a.m20761a(cls, th);
                intent = null;
