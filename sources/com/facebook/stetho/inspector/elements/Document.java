...
public final class Document extends ThreadBoundProxy {
        ...
        update.getChangedElements(new Accumulator<Object>() {
            private Accumulator<Object> insertedElements = new Accumulator<Object>() {
                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C124555.this.listenerInsertedElements.add(obj);
                    }
                }
            };
            /* access modifiers changed from: private */
            ...
            public void store(Object obj) {
                ...
                if (Document.this.mObjectIdMapper.containsObject(obj) && !this.listenerInsertedElements.contains(obj)) {
                    ...
                    Document.updateListenerChildren(access$900, list, this.insertedElements);
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m20238e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    public void updateTree() {
        ...
        LogUtil.m20234d("Document.updateTree() completed in %s ms%s", objArr);
    }
