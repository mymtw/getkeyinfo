...
public class NetworkEventReporterImpl implements NetworkEventReporter {
    ...
    public void requestWillBeSent(NetworkEventReporter.InspectorRequest inspectorRequest) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            requestWillBeSentParams.requestId = inspectorRequest.mo40385id();
            requestWillBeSentParams.frameId = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
            requestWillBeSentParams.loaderId = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
    ...
    public void responseHeadersReceived(NetworkEventReporter.InspectorResponse inspectorResponse) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            responseReceivedParams.frameId = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
            responseReceivedParams.loaderId = IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
    ...
    public void webSocketWillSendHandshakeRequest(NetworkEventReporter.InspectorWebSocketRequest inspectorWebSocketRequest) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            webSocketWillSendHandshakeRequestParams.requestId = inspectorWebSocketRequest.mo40385id();
