...
public class CrashDumperPlugin implements DumperPlugin {
    ...
    private void doKill(DumperContext dumperContext, Iterator<String> it) throws DumpException {
        ...
        try {
            ...
            Util.copy(start.getInputStream(), dumperContext.getStdout(), new byte[RecyclerView.C3084b0.FLAG_ADAPTER_FULLUPDATE]);
            start.destroy();
        } catch (IOException e) {
    ...
    public void dump(DumperContext dumperContext) throws DumpException {
        ...
        if ("throw".equals(nextOptionalArg)) {
            ...
            if (nextOptionalArg != null) {
                throw new DumpUsageException(C0326j.m864i("Unsupported command: ", nextOptionalArg));
            }
        }
    }
