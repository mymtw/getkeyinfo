...
public class ObjectMapper {
        ...
        for (Field field : fields) {
            if (!Modifier.isStatic(field.getModifiers())) {
                ...
                try {
                    ...
                    h.append(" type ");
                    h.append(valueForField != null ? valueForField.getClass().getName() : "null");
    ...
    private List<Object> convertArrayToList(Field field, JSONArray jSONArray) throws IllegalAccessException, JSONException {
        if (List.class.isAssignableFrom(field.getType())) {
            ...
            StringBuilder h = C0072d.m201h("Only able to handle a single type in a list ");
            h.append(field.getName());
            throw new IllegalArgumentException(h.toString());
        }
        StringBuilder h2 = C0072d.m201h("only know how to deserialize List<?> on field ");
    ...
    private Enum getEnumByMethod(String str, Class<? extends Enum> cls, Method method) {
        ...
        StringBuilder h = C0072d.m201h("No enum constant ");
    ...
    private Object getValueForField(Field field, Object obj) throws JSONException {
        if (obj != null) {
            try {
                ...
                StringBuilder h = C0072d.m201h("Unable to set value for field ");
                h.append(field.getName());
                throw new IllegalArgumentException(h.toString(), e);
            }
        }
