...
/* renamed from: com.braze.ui.actions.brazeactions.BrazeActionParser$getActionType$1 */
public final class BrazeActionParser$getActionType$1 extends Lambda implements C19846a<String> {
    ...
    public final String invoke() {
        StringBuilder h = C0072d.m201h("Cannot parse invalid action of type ");
        h.append(this.$type);
        h.append(" and data ");
        h.append(this.$data);
        return h.toString();
