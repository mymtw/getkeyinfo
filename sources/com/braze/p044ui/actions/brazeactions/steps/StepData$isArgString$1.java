...
/* renamed from: com.braze.ui.actions.brazeactions.steps.StepData$isArgString$1 */
public final class StepData$isArgString$1 extends Lambda implements C19846a<String> {
    ...
    public final String invoke() {
        ...
        h.append(this.$index);
        h.append("] is not a String. Source: ");
