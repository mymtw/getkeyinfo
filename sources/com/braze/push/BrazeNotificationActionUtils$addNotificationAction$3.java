...
final class BrazeNotificationActionUtils$addNotificationAction$3 extends Lambda implements C19846a<String> {
    ...
    public final String invoke() {
        ...
        h.append(" Setting intent class to trampoline activity");
        return h.toString();
    }
}
