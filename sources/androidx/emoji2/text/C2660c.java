...
public final class C2660c {
    ...
    public static class C2661a {
        /* renamed from: a */
        public Signature[] mo10061a(PackageManager packageManager, String str) throws PackageManager.NameNotFoundException {
            return packageManager.getPackageInfo(str, 64).signatures;
        }
    }

    /* renamed from: androidx.emoji2.text.c$b */
    public static class C2662b extends C2661a {
    }

    /* renamed from: androidx.emoji2.text.c$c */
    public static class C2663c extends C2662b {
        /* renamed from: a */
        public final Signature[] mo10061a(PackageManager packageManager, String str) throws PackageManager.NameNotFoundException {
            return packageManager.getPackageInfo(str, 64).signatures;
        }
    }
    ...
    public static androidx.emoji2.text.C2684j m6409a(android.content.Context r8) {
        /*
        ...
        L_0x004e:
            ...
            android.content.pm.Signature[] r0 = r0.mo10061a(r1, r4)     // Catch:{ NameNotFoundException -> 0x0076 }
        ...
        L_0x006a:
            ...
            b1.e r1 = new b1.e     // Catch:{ NameNotFoundException -> 0x0076 }
        ...
        L_0x0085:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.C2660c.m6409a(android.content.Context):androidx.emoji2.text.j");
    }
}
