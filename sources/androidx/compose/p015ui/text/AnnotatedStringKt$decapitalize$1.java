...
final class AnnotatedStringKt$decapitalize$1 extends Lambda implements C19862q<String, Integer, Integer, String> {
    public final /* synthetic */ C7175c $localeList;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnnotatedStringKt$decapitalize$1(C7175c cVar) {
        super(3);
    ...
    public final String invoke(String str, int i, int i2) {
        ...
        if (i == 0) {
            ...
            Locale locale2 = ((C7173a) dVar).f15949a;
