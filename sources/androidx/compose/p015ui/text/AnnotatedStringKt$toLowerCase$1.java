...
final class AnnotatedStringKt$toLowerCase$1 extends Lambda implements C19862q<String, Integer, Integer, String> {
    public final /* synthetic */ C7175c $localeList;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnnotatedStringKt$toLowerCase$1(C7175c cVar) {
        super(3);
    ...
    public final String invoke(String str, int i, int i2) {
        ...
        String lowerCase = substring.toLowerCase(((C7173a) dVar).f15949a);
