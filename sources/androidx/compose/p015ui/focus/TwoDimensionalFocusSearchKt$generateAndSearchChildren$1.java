...
public final class TwoDimensionalFocusSearchKt$generateAndSearchChildren$1 extends Lambda implements C19857l<C1667b.C1668a, Boolean> {
    ...
    public TwoDimensionalFocusSearchKt$generateAndSearchChildren$1(FocusModifier focusModifier, FocusModifier focusModifier2, int i, C19857l<? super FocusModifier, Boolean> lVar) {
        super(1);
    ...
    public final Boolean invoke(C1667b.C1668a aVar) {
        ...
        Boolean valueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m3117g(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound));
