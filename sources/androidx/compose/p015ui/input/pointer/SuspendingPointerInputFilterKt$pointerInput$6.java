...
public final class SuspendingPointerInputFilterKt$pointerInput$6 extends Lambda implements C19862q<C1436d, C1302d, Integer, C1436d> {
    ...
    public SuspendingPointerInputFilterKt$pointerInput$6(Object[] objArr, C19861p<? super C1652w, ? super C19340c<? super C19394m>, ? extends Object> pVar) {
        super(3);
        this.$keys = objArr;
        this.$block = pVar;
    }
    ...
    public final C1436d invoke(C1436d dVar, C1302d dVar2, int i) {
        ...
        C1830f0 f0Var = new C1830f0(2);
        f0Var.mo7209a(suspendingPointerInputFilter);
        f0Var.mo7210b(objArr);
        C1415u.m3032f(((ArrayList) f0Var.f4088a).toArray(new Object[((ArrayList) f0Var.f4088a).size()]), new SuspendingPointerInputFilterKt$pointerInput$6$2$1(suspendingPointerInputFilter, pVar, (C19340c<? super SuspendingPointerInputFilterKt$pointerInput$6$2$1>) null), dVar2);
        dVar2.mo5406H();
