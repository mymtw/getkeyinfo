...
public final class VectorComposeKt$Path$2$13 extends Lambda implements C19861p<PathComponent, Float, C19394m> {
    ...
    public final void invoke(PathComponent pathComponent, float f) {
        ...
        if (!(pathComponent.f3380l == f)) {
            pathComponent.f3380l = f;
