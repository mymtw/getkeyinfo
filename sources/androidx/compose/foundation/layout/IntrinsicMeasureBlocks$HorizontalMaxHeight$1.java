...
public final class IntrinsicMeasureBlocks$HorizontalMaxHeight$1 extends Lambda implements C19862q<List<? extends C1681g>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(List<? extends C1681g> list, int i, int i2) {
        ...
        return Integer.valueOf(C0761x.m1739q(list, C06521.INSTANCE, C06532.INSTANCE, i, i2, LayoutOrientation.Horizontal, LayoutOrientation.Vertical));
    }
}
