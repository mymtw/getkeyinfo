...
final class Arrangement$Absolute$spacedBy$1 extends Lambda implements C19861p<Integer, LayoutDirection, Integer> {
    public final /* synthetic */ C1428a.C1430b $alignment;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Arrangement$Absolute$spacedBy$1(C1428a.C1430b bVar) {
        super(2);
        this.$alignment = bVar;
    }
