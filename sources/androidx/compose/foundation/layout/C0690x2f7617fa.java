...
public final class C0690x2f7617fa extends Lambda implements C19862q<C1436d, C1302d, Integer, C1436d> {
    public C0690x2f7617fa() {
        super(3);
    }
    ...
    public final C1436d invoke(C1436d dVar, C1302d dVar2, int i) {
        ...
        if (I || v == C1302d.C1303a.f2828a) {
            v = new InsetsPaddingModifier(c.f1518m);
            dVar2.mo5454o(v);
        }
        dVar2.mo5406H();
