...
public final class BasicTextFieldKt$BasicTextField$4 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public final void invoke(C1302d dVar, int i) {
        ...
        String str2 = str;
        BasicTextFieldKt.m1952b(str2, this.$onValueChange, this.$modifier, this.$enabled, this.$readOnly, this.$textStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$visualTransformation, this.$onTextLayout, this.$interactionSource, this.$cursorBrush, this.$decorationBox, dVar2, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
