...
final class ToggleableKt$triStateToggleable$2 extends Lambda implements C19862q<C1436d, C1302d, Integer, C1436d> {
    ...
    public ToggleableKt$triStateToggleable$2(ToggleableState toggleableState, boolean z, C1900g gVar, C19846a<C19394m> aVar) {
        super(3);
    ...
    public final C1436d invoke(C1436d dVar, C1302d dVar2, int i) {
        ...
        dVar2.mo5406H();
        C1436d b = C0893a.m1947b((C0871p) dVar2.mo5410J(IndicationKt.f1271a), (C0640j) v, dVar, gVar, toggleableState, this.$onClick, z);
        dVar2.mo5406H();
        return b;
    }
}
