...
public final class LazyDslKt$items$8 extends Lambda implements C19863r<C0777d, Integer, C1302d, Integer, C19394m> {
    ...
    public LazyDslKt$items$8(C19863r<? super C0777d, Object, ? super C1302d, ? super Integer, C19394m> rVar, Object[] objArr) {
        super(4);
    ...
    public final void invoke(C0777d dVar, int i, C1302d dVar2, int i2) {
        ...
        if ((i3 & 731) != 146 || !dVar2.mo5442i()) {
            this.$itemContent.invoke(dVar, this.$items[i], dVar2, Integer.valueOf(i3 & 14));
        } else {
            dVar2.mo5396C();
        }
    }
