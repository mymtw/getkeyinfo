...
public final class LazyGridDslKt$itemsIndexed$5 extends Lambda implements C19863r<C0808j, Integer, C1302d, Integer, C19394m> {
    ...
    public LazyGridDslKt$itemsIndexed$5(C19864s<? super C0808j, ? super Integer, Object, ? super C1302d, ? super Integer, C19394m> sVar, List<Object> list) {
        super(4);
    ...
    public final void invoke(C0808j jVar, int i, C1302d dVar, int i2) {
        ...
        if ((i3 & 731) != 146 || !dVar.mo5442i()) {
            this.$itemContent.invoke(jVar, Integer.valueOf(i), this.$items.get(i), dVar, Integer.valueOf((i3 & 14) | (i3 & 112)));
        } else {
            dVar.mo5396C();
        }
    }
