...
/* renamed from: androidx.compose.runtime.snapshots.j */
public final class C1392j<K, V> extends C1393k<K, V, K> {
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1392j(C1397o<K, V> oVar) {
        super(oVar);
    ...
    public final boolean contains(Object obj) {
        return this.f3036b.containsKey(obj);
    }
    ...
    public final boolean containsAll(Collection<? extends Object> collection) {
        ...
        while (it.hasNext()) {
            if (!this.f3036b.containsKey(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public final Iterator iterator() {
        ...
        return new C1404u(oVar, ((C7790b) oVar.mo6035a().f3042c.entrySet()).iterator());
    }

    public final boolean remove(Object obj) {
        return this.f3036b.remove(obj) != null;
    }
    ...
    public final boolean removeAll(Collection<? extends Object> collection) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (this.f3036b.remove(it.next()) != null || z) {
                    z = true;
                }
            }
        }
