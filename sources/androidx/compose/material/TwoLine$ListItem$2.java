...
public final class TwoLine$ListItem$2 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public final void invoke(C1302d dVar, int i) {
        this.$tmp0_rcvr.mo5216a(this.$modifier, this.$icon, this.$text, this.$secondaryText, this.$overlineText, this.$trailing, dVar, this.$$changed | 1, this.$$default);
    }
}
