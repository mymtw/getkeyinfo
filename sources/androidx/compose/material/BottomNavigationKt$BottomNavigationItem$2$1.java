...
final class BottomNavigationKt$BottomNavigationItem$2$1 extends Lambda implements C19862q<Float, C1302d, Integer, C19394m> {
    ...
    public BottomNavigationKt$BottomNavigationItem$2$1(boolean z, C19861p<? super C1302d, ? super Integer, C19394m> pVar, C19861p<? super C1302d, ? super Integer, C19394m> pVar2, int i) {
        super(3);
    ...
    public final void invoke(float f, C1302d dVar, int i) {
        ...
        if ((i & 91) != 18 || !dVar.mo5442i()) {
            ...
            BottomNavigationKt.m2169b(this.$icon, this.$styledLabel, f, dVar, (this.$$dirty >> 9) & 14);
            return;
        }
        dVar.mo5396C();
    }
