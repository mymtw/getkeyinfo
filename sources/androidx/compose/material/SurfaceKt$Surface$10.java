...
import androidx.compose.foundation.selection.C0893a;
...
final class SurfaceKt$Surface$10 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public SurfaceKt$Surface$10(C1436d dVar, C1530k0 k0Var, long j, float f, int i, C0556g gVar, float f2, boolean z, C0640j jVar, boolean z2, C19857l<? super Boolean, C19394m> lVar, C19861p<? super C1302d, ? super Integer, C19394m> pVar, int i2) {
        super(2);
        this.$modifier = dVar;
        this.$shape = k0Var;
        this.$color = j;
    ...
    public final void invoke(C1302d dVar, int i) {
        ...
        if ((i & 11) != 2 || !dVar.mo5442i()) {
            ...
            C1436d a2 = C0893a.m1946a(SurfaceKt.m2237d(dVar3, k0Var2, SurfaceKt.m2238e(this.$color, (C1215n0) dVar2.mo5410J(ElevationOverlayKt.f2206a), this.$absoluteElevation, dVar, (this.$$dirty >> 15) & 14), this.$border, this.$elevation), this.$checked, this.$interactionSource, C1244j.m2369a(false, 0.0f, 0, dVar, 0, 7), this.$enabled, new C1900g(2), this.$onCheckedChange);
