...
public final class SurfaceKt$Surface$4 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public SurfaceKt$Surface$4(C1436d dVar, C1530k0 k0Var, long j, float f, int i, C0556g gVar, float f2, C0640j jVar, boolean z, C19846a<C19394m> aVar, C19861p<? super C1302d, ? super Integer, C19394m> pVar) {
        super(2);
        this.$modifier = dVar;
        this.$shape = k0Var;
        this.$color = j;
    ...
    public final void invoke(C1302d dVar, int i) {
        ...
        if ((i & 11) != 2 || !dVar.mo5442i()) {
            ...
            C1436d c = ClickableKt.m1297c(SurfaceKt.m2237d(dVar3, k0Var2, SurfaceKt.m2238e(this.$color, (C1215n0) dVar2.mo5410J(ElevationOverlayKt.f2206a), this.$absoluteElevation, dVar, (this.$$dirty >> 12) & 14), this.$border, this.$elevation), this.$interactionSource, C1244j.m2369a(false, 0.0f, 0, dVar, 0, 7), this.$enabled, (String) null, new C1900g(0), this.$onClick, 8);
            C19861p<C1302d, Integer, C19394m> pVar = this.$content;
            int i2 = this.$$dirty;
            dVar2.mo5465u(733328855);
            C1711v c2 = BoxKt.m1457c(C1428a.C1429a.f3105a, true, dVar2);
            ...
            if (dVar.mo5446k() instanceof C1299c) {
                ...
                dVar.mo5394B();
                Updater.m2571b(dVar2, c2, ComposeUiNode.Companion.f3781e);
                ...
                dVar2.mo5465u(-390905273);
                pVar.invoke(dVar2, Integer.valueOf((i2 >> 27) & 14));
                dVar.mo5406H();
                dVar.mo5406H();
                dVar.mo5406H();
                dVar.mo5456p();
