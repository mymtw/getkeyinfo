...
final class OutlinedTextFieldMeasurePolicy$maxIntrinsicWidth$1 extends Lambda implements C19861p<C1681g, Integer, Integer> {
    ...
    public final Integer invoke(C1681g gVar, int i) {
        ...
        return Integer.valueOf(gVar.mo6664D(i));
    }
}
