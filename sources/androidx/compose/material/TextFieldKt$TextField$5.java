...
final class TextFieldKt$TextField$5 extends Lambda implements C19862q<C19861p<? super C1302d, ? super Integer, ? extends C19394m>, C1302d, Integer, C19394m> {
    ...
    public final void invoke(C19861p<? super C1302d, ? super Integer, C19394m> pVar, C1302d dVar, int i) {
        ...
        if ((i2 & 91) != 18 || !dVar.mo5442i()) {
            ...
            int i3 = this.$$dirty;
            int i4 = this.$$dirty1;
            textFieldDefaults.mo5166c(str2, pVar, z, z2, xVar, jVar, z3, pVar3, pVar4, pVar5, pVar6, a2Var, (C0759v) null, dVar, ((i4 >> 3) & 7168) | ((i2 << 3) & 112) | ((i3 >> 3) & 896) | ((i4 << 9) & 57344) | ((i4 >> 3) & 458752) | ((i4 << 18) & 3670016) | ((i3 << 3) & 29360128) | ((i3 << 3) & 234881024) | ((i3 << 3) & 1879048192), ((i3 >> 27) & 14) | 3072 | ((i4 >> 21) & 112), RecyclerView.C3084b0.FLAG_APPEARED_IN_PRE_LAYOUT);
            return;
        }
        dVar.mo5396C();
    }
