...
@C19060c(mo70540c = "androidx.compose.material.DefaultButtonElevation$elevation$1", mo70541f = "Button.kt", mo70542l = {506}, mo70543m = "invokeSuspend")
final class DefaultButtonElevation$elevation$1 extends SuspendLambda implements C19861p<C19525d0, C19340c<? super C19394m>, Object> {
    public final /* synthetic */ C0639i $interactionSource;
    public final /* synthetic */ SnapshotStateList<C0638h> $interactions;
    public int label;

    /* renamed from: androidx.compose.material.DefaultButtonElevation$elevation$1$a */
    public static final class C1068a implements C19600e<C0638h> {

        /* renamed from: b */
        public final /* synthetic */ SnapshotStateList<C0638h> f2200b;

        public C1068a(SnapshotStateList<C0638h> snapshotStateList) {
            this.f2200b = snapshotStateList;
        }
        ...
        public final Object emit(Object obj, C19340c cVar) {
            ...
            if (hVar instanceof C0635e) {
                ...
                this.f2200b.remove((Object) ((C0636f) hVar).f1378a);
            } else if (hVar instanceof C0632b) {
                this.f2200b.add(hVar);
            } else if (hVar instanceof C0633c) {
                this.f2200b.remove((Object) ((C0633c) hVar).f1377a);
            } else if (hVar instanceof C0643m) {
                this.f2200b.add(hVar);
            } else if (hVar instanceof C0644n) {
                this.f2200b.remove((Object) ((C0644n) hVar).f1382a);
            } else if (hVar instanceof C0642l) {
                this.f2200b.remove((Object) ((C0642l) hVar).f1380a);
            }
    ...
    public DefaultButtonElevation$elevation$1(C0639i iVar, SnapshotStateList<C0638h> snapshotStateList, C19340c<? super DefaultButtonElevation$elevation$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke(C19525d0 d0Var, C19340c<? super C19394m> cVar) {
        return ((DefaultButtonElevation$elevation$1) create(d0Var, cVar)).invokeSuspend(C19394m.f43287a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C1068a aVar = new C1068a(this.$interactions);
            this.label = 1;
            c.getClass();
