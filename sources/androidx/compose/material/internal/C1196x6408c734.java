...
public final class C1196x6408c734 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public C1196x6408c734(PopupLayout popupLayout, C1342k1<? extends C19861p<? super C1302d, ? super Integer, C19394m>> k1Var) {
        super(2);
    ...
    public final void invoke(C1302d dVar, int i) {
        if ((i & 11) != 2 || !dVar.mo5442i()) {
            C1436d a = SemanticsModifierKt.m4174a(C1436d.C1437a.f3125b, false, C11971.INSTANCE);
            final PopupLayout popupLayout = this.$this_apply;
            C1436d I = C0005b.m15I(C18263b.m30849j0(a, new C19857l<C7290i, C19394m>() {
                public /* synthetic */ Object invoke(Object obj) {
                    m34766invokeozmzZPI(((C7290i) obj).f16171a);
                    return C19394m.f43287a;
                }

                /* renamed from: invoke-ozmzZPI  reason: not valid java name */
                public final void m34766invokeozmzZPI(long j) {
                    PopupLayout popupLayout = popupLayout;
                    popupLayout.f2495i.setValue(new C7290i(j));
                    popupLayout.updatePosition();
                }
            }), ((Boolean) this.$this_apply.f2496j.getValue()).booleanValue() ? 1.0f : 0.0f);
            final C1342k1<C19861p<C1302d, Integer, C19394m>> k1Var = this.$currentContent$delegate;
            ComposableLambdaImpl A = C18263b.m30805A(dVar, 2080999218, new C19861p<C1302d, Integer, C19394m>() {
                public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                    invoke((C1302d) obj, ((Number) obj2).intValue());
                    return C19394m.f43287a;
                }
                ...
                public final void invoke(C1302d dVar, int i) {
                    if ((i & 11) != 2 || !dVar.mo5442i()) {
                        ...
                        C1411t tVar = ExposedDropdownMenuPopupKt.f2482a;
            ...
            dVar.mo5465u(1769324208);
            ExposedDropdownMenuPopupKt$SimpleStack$1 exposedDropdownMenuPopupKt$SimpleStack$1 = ExposedDropdownMenuPopupKt$SimpleStack$1.f2486a;
            ...
            if (dVar.mo5446k() instanceof C1299c) {
                ...
                dVar.mo5394B();
                Updater.m2571b(dVar, exposedDropdownMenuPopupKt$SimpleStack$1, ComposeUiNode.Companion.f3781e);
