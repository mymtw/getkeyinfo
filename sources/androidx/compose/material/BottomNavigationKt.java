...
public final class BottomNavigationKt {
    ...
    /* renamed from: a */
    public static final C0433j0<Float> f2176a = new C0433j0<>((int) LogSeverity.NOTICE_VALUE, (C0448r) C0450s.f1167a, 2);

    /* renamed from: b */
    public static final float f2177b = ((float) 56);

    /* renamed from: c */
    public static final float f2178c;

    /* renamed from: d */
    public static final float f2179d;
    ...
    /* renamed from: a */
    public static final void m2168a(long j, long j2, boolean z, C19862q<? super Float, ? super C1302d, ? super Integer, C19394m> qVar, C1302d dVar, int i) {
        int i2;
        long j3 = j;
        long j4 = j2;
        boolean z2 = z;
        ...
        int i3 = i;
        ComposerImpl h = dVar.mo5440h(-985175058);
        if ((i3 & 14) == 0) {
        ...
        if ((i2 & 5851) != 1170 || !h.mo5442i()) {
            C0424f b = C0411a.m1106b(z2 ? 1.0f : 0.0f, f2176a, h, 48, 12);
            long e0 = C18263b.m30841e0(j4, ((Number) b.getValue()).floatValue(), j3);
            CompositionLocalKt.m2530a(new C1412t0[]{ContentColorKt.f2199a.mo5908b(new C1545s(C1545s.m3356b(e0, 1.0f))), ContentAlphaKt.f2198a.mo5908b(Float.valueOf(C1545s.m3358d(e0)))}, C18263b.m30805A(h, -138092754, new BottomNavigationKt$BottomNavigationTransition$1(qVar2, i2, b)), h, 56);
        } else {
            h.mo5396C();
        }
        C1418v0 U = h.mo5421U();
        if (U != null) {
            U.f3081d = new BottomNavigationKt$BottomNavigationTransition$2(j, j2, z, qVar, i);
        }
    }

    /* renamed from: b */
    public static final void m2169b(C19861p pVar, C19861p pVar2, float f, C1302d dVar, int i) {
        int i2;
        ...
        float f2 = f;
        int i3 = i;
        ComposerImpl h = dVar.mo5440h(-1162995092);
        if ((i3 & 14) == 0) {
        ...
        if ((i4 & 731) != 146 || !h.mo5442i()) {
            C1191i iVar = new C1191i(pVar4, f2);
            ...
            if (h.f2715a instanceof C1299c) {
                ...
                C0326j.m868m(0, a, C13983i.m21490i(h, j1Var, pVar8, h), h, 2058660585, 395677717);
                ...
                if (h.f2715a instanceof C1299c) {
                    ...
                    if (pVar4 != null) {
                        C1436d H0 = C15588c1.m25283H0(C0005b.m15I(C1993m.m4358S(aVar6, ResponseConstants.LABEL), f2), f2178c, 0.0f, 2);
                        ...
                        if (composerImpl3.f2715a instanceof C1299c) {
                            ...
                            composerImpl.mo5465u(150842644);
                            z = false;
        ...
        if (U != null) {
            U.f3081d = new BottomNavigationKt$BottomNavigationItemBaselineLayout$3(pVar, pVar4, f2, i3);
        }
    }
}
