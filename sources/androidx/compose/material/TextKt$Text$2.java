...
public final class TextKt$Text$2 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public TextKt$Text$2(String str, C1436d dVar, long j, long j2, C1957k kVar, C1959m mVar, C1952g gVar, long j3, C2030e eVar, C2029d dVar2, long j4, int i, boolean z, int i2, C19857l<? super C2021q, C19394m> lVar, C2023s sVar, int i3, int i4, int i5) {
        super(2);
        this.$text = str;
        this.$modifier = dVar;
        this.$color = j;
    ...
    public final void invoke(C1302d dVar, int i) {
        ...
        String str2 = str;
        TextKt.m2283b(str2, this.$modifier, this.$color, this.$fontSize, this.$fontStyle, this.$fontWeight, this.$fontFamily, this.$letterSpacing, this.$textDecoration, this.$textAlign, this.$lineHeight, this.$overflow, this.$softWrap, this.$maxLines, this.$onTextLayout, this.$style, dVar2, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
