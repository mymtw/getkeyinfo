...
public final class TextFieldDefaults$TextFieldDecorationBox$1 extends Lambda implements C19861p<C1302d, Integer, C19394m> {
    ...
    public final void invoke(C1302d dVar, int i) {
        ...
        textFieldDefaults2.mo5166c(this.$value, this.$innerTextField, this.$enabled, this.$singleLine, this.$visualTransformation, this.$interactionSource, this.$isError, this.$label, this.$placeholder, this.$leadingIcon, this.$trailingIcon, this.$colors, this.$contentPadding, dVar2, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
