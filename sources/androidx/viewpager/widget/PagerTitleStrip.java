...
public class PagerTitleStrip extends ViewGroup {
    ...
    private final C3323a mPageListener;
    ...
    private WeakReference<C7717a> mWatchingAdapter;

    /* renamed from: androidx.viewpager.widget.PagerTitleStrip$a */
    public class C3323a extends DataSetObserver implements ViewPager.C3334i, ViewPager.C3333h {
        ...
        public final void mo12624a(ViewPager viewPager, C7717a aVar, C7717a aVar2) {
            PagerTitleStrip.this.updateAdapter(aVar, aVar2);
        }
    ...
    public static class C3324b extends SingleLineTransformationMethod {

        /* renamed from: b */
        public Locale f7790b;

        public C3324b(Context context) {
            this.f7790b = context.getResources().getConfiguration().locale;
        }

        public final CharSequence getTransformation(CharSequence charSequence, View view) {
            CharSequence transformation = super.getTransformation(charSequence, view);
            if (transformation != null) {
                return transformation.toString().toUpperCase(this.f7790b);
            }
            return null;
        }
    }
    ...
    private static void setSingleLineAllCaps(TextView textView) {
        textView.setTransformationMethod(new C3324b(textView.getContext()));
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (parent instanceof ViewPager) {
            ...
            C7717a adapter = viewPager.getAdapter();
            viewPager.setInternalPageChangeListener(this.mPageListener);
            viewPager.addOnAdapterChangeListener(this.mPageListener);
            this.mPager = viewPager;
            WeakReference<C7717a> weakReference = this.mWatchingAdapter;
    ...
    public void onDetachedFromWindow() {
        ...
        if (viewPager != null) {
            updateAdapter(viewPager.getAdapter(), (C7717a) null);
            this.mPager.setInternalPageChangeListener((ViewPager.C3334i) null);
    ...
    public void updateAdapter(C7717a aVar, C7717a aVar2) {
        if (aVar != null) {
            aVar.f17111b.unregisterObserver(this.mPageListener);
            this.mWatchingAdapter = null;
        }
        if (aVar2 != null) {
            aVar2.f17111b.registerObserver(this.mPageListener);
        ...
        if (viewPager != null) {
            ...
            updateText(viewPager.getCurrentItem(), aVar2);
            requestLayout();
        }
    }

    public void updateText(int i, C7717a aVar) {
        int j = aVar != null ? aVar.mo20184j() : 0;
        this.mUpdatingText = true;
        CharSequence charSequence = null;
        this.mPrevText.setText((i < 1 || aVar == null) ? null : aVar.mo20186l(i - 1));
        this.mCurrText.setText((aVar == null || i >= j) ? null : aVar.mo20186l(i));
        int i2 = i + 1;
        if (i2 < j && aVar != null) {
            charSequence = aVar.mo20186l(i2);
        }
