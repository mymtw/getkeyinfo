...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new C2734b();
    public View mProgressContainer;
    private final Runnable mRequestFocus = new C2733a();
    public TextView mStandardEmptyView;

    /* renamed from: androidx.fragment.app.ListFragment$a */
    public class C2733a implements Runnable {
        public C2733a() {
        }
    ...
    public class C2734b implements AdapterView.OnItemClickListener {
        public C2734b() {
        }
