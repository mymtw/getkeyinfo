...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (view != null && view.getVisibility() != 8 && mode != 1073741824) {
                setMeasuredDimension(getMeasuredWidth(), Math.min((!isCollapsed(this.mActionBarView) ? getMeasuredHeightWithMargins(this.mActionBarView) : !isCollapsed(this.mContextView) ? getMeasuredHeightWithMargins(this.mContextView) : 0) + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i2) : Api.BaseClientBuilder.API_PRIORITY_OTHER));
            }
        }
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        C0302b bVar = new C0302b(this);
        WeakHashMap<View, C2330s0> weakHashMap = C2364y.f5646a;
        C2364y.C2368d.m5227q(this, bVar);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C18263b.f40067g);
        boolean z = false;
