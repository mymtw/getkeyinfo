...
import androidx.appcompat.app.C0158h;
...
public class ContentFrameLayout extends FrameLayout {
    private C0261a mAttachListener;
    ...
    public void onAttachedToWindow() {
        ...
        C0261a aVar = this.mAttachListener;
        if (aVar != null) {
            aVar.getClass();
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        C0261a aVar = this.mAttachListener;
        if (aVar != null) {
            AppCompatDelegateImpl appCompatDelegateImpl = ((C0158h) aVar).f390a;
            C0357w wVar = appCompatDelegateImpl.f329m;
            if (wVar != null) {
                wVar.dismissPopups();
            }
            if (appCompatDelegateImpl.f334r != null) {
                appCompatDelegateImpl.f321g.getDecorView().removeCallbacks(appCompatDelegateImpl.f335s);
                if (appCompatDelegateImpl.f334r.isShowing()) {
                    try {
                        appCompatDelegateImpl.f334r.dismiss();
                    } catch (IllegalArgumentException unused) {
                    }
                }
                appCompatDelegateImpl.f334r = null;
            }
            C2330s0 s0Var = appCompatDelegateImpl.f336t;
            if (s0Var != null) {
                s0Var.mo8919b();
            }
            MenuBuilder menuBuilder = appCompatDelegateImpl.mo1302P(0).f350h;
            if (menuBuilder != null) {
                menuBuilder.close();
            }
        }
    ...
    public void setAttachListener(C0261a aVar) {
