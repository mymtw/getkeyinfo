...
public class TintContextWrapper extends ContextWrapper {
    ...
    private TintContextWrapper(Context context) {
        ...
        this.mResources = new C0338o0(this, context.getResources());
        this.mTheme = null;
    }

    private static boolean shouldWrap(Context context) {
        return !(context instanceof TintContextWrapper) && !(context.getResources() instanceof C0338o0) && !(context.getResources() instanceof VectorEnabledTintResources) && VectorEnabledTintResources.shouldBeUsed();
    }
