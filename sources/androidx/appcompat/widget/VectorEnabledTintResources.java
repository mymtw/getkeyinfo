...
public class VectorEnabledTintResources extends C0327j0 {
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        ...
        C0323i0 c = C0323i0.m848c();
        synchronized (c) {
            Drawable i2 = c.mo3068i(context, i);
            if (i2 == null) {
                i2 = getDrawableCanonical(i);
            }
            j = i2 != null ? c.mo3069j(context, i, false, i2) : null;
        }
        return j;
    }
