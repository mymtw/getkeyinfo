...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public class C0262a implements Runnable {
        public C0262a() {
        }
    ...
    public class C0263b implements Runnable {
        public C0263b() {
        }
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        C0299a0 o;
        View view = this.mSrc;
        C6826c popup = getPopup();
        if (popup == null || !popup.mo2004b() || (o = popup.mo2015o()) == null || !o.isShown()) {
            return false;
        }
        MotionEvent obtainNoHistory = MotionEvent.obtainNoHistory(motionEvent);
        toGlobalMotionEvent(view, obtainNoHistory);
        toLocalMotionEvent(o, obtainNoHistory);
        boolean onForwardedEvent = o.onForwardedEvent(obtainNoHistory, this.mActivePointerId);
    ...
    public abstract C6826c getPopup();

    public boolean onForwardingStarted() {
        C6826c popup = getPopup();
        if (popup == null || popup.mo2004b()) {
            return true;
        }
        popup.mo2003a();
        return true;
