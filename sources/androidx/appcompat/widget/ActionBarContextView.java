...
public class ActionBarContextView extends C0296a {
    private View mClose;
    ...
    public class C0225a implements View.OnClickListener {

        /* renamed from: b */
        public final /* synthetic */ C0194a f647b;

        public C0225a(C0194a aVar) {
            this.f647b = aVar;
        }
    ...
    public void initForMode(C0194a aVar) {
        ...
        findViewById.setOnClickListener(new C0225a(aVar));
        MenuBuilder e = aVar.mo1434e();
        ActionMenuPresenter actionMenuPresenter = this.mActionMenuPresenter;
        if (actionMenuPresenter != null) {
            actionMenuPresenter.mo2152b();
            ActionMenuPresenter.C0231a aVar2 = actionMenuPresenter.f662v;
            if (aVar2 != null && aVar2.mo2028b()) {
                aVar2.f621j.dismiss();
            }
        }
        ...
        e.addMenuPresenter(this.mActionMenuPresenter, this.mPopupContext);
        ActionMenuPresenter actionMenuPresenter3 = this.mActionMenuPresenter;
        C0220g gVar = actionMenuPresenter3.f571i;
        if (gVar == null) {
            C0220g gVar2 = (C0220g) actionMenuPresenter3.f567e.inflate(actionMenuPresenter3.f569g, this, false);
            actionMenuPresenter3.f571i = gVar2;
            gVar2.initialize(actionMenuPresenter3.f566d);
            actionMenuPresenter3.updateMenuView(true);
        }
        C0220g gVar3 = actionMenuPresenter3.f571i;
        if (gVar != gVar3) {
        ...
        C2364y.C2368d.m5227q(actionMenuView, (Drawable) null);
    ...
    public void onDetachedFromWindow() {
        ...
        if (actionMenuPresenter != null) {
            actionMenuPresenter.mo2152b();
            ActionMenuPresenter.C0231a aVar = this.mActionMenuPresenter.f662v;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!(view == null || view.getVisibility() == 8)) {
            ...
            int next = C0296a.next(paddingRight, i5, a);
            paddingRight = C0296a.next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, a), i6, a);
        }
        int i7 = paddingRight;
        LinearLayout linearLayout = this.mTitleLayout;
        if (!(linearLayout == null || this.mCustomView != null || linearLayout.getVisibility() == 8)) {
            i7 += positionChild(this.mTitleLayout, i7, paddingTop, paddingTop2, a);
        }
        int i8 = i7;
        View view2 = this.mCustomView;
        if (view2 != null) {
            positionChild(view2, i8, paddingTop, paddingTop2, a);
        }
        int paddingLeft = a ? getPaddingLeft() : (i3 - i) - getPaddingRight();
        ActionMenuView actionMenuView = this.mMenuView;
        if (actionMenuView != null) {
            positionChild(actionMenuView, paddingLeft, paddingTop, paddingTop2, !a);
        }
    }
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        initTitle();
        C2364y.m5202q(this, charSequence);
    }
    ...
    public /* bridge */ /* synthetic */ C2330s0 setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        Drawable drawable;
        int resourceId;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C18263b.f40070j, i, 0);
