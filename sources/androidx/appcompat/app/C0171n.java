...
public final class C0171n {
    ...
    /* renamed from: a */
    public final void mo1426a(double d, double d2, long j) {
        ...
        if (sin3 >= 1.0d) {
            ...
            this.f414a = Math.round((sin2 + acos) * 8.64E7d) + 946728000000L;
            long round = Math.round((sin2 - acos) * 8.64E7d) + 946728000000L;
            this.f415b = round;
            if (round >= j || this.f414a <= j) {
                this.f416c = 1;
            } else {
                this.f416c = 0;
            }
