...
public class MenuBuilder implements SupportMenu {
    ...
    private CopyOnWriteArrayList<WeakReference<C0218f>> mPresenters = new CopyOnWriteArrayList<>();
    ...
    public interface C0200a {
        /* renamed from: a */
        boolean mo1310a(MenuBuilder menuBuilder, MenuItem menuItem);

        /* renamed from: b */
        void mo1311b(MenuBuilder menuBuilder);
    }
    ...
    private void dispatchPresenterUpdate(boolean z) {
        if (!this.mPresenters.isEmpty()) {
            ...
            Iterator<WeakReference<C0218f>> it = this.mPresenters.iterator();
            while (it.hasNext()) {
                WeakReference next = it.next();
                C0218f fVar = (C0218f) next.get();
                if (fVar == null) {
    ...
    private boolean dispatchSubMenuSelected(SubMenuBuilder subMenuBuilder, C0218f fVar) {
        boolean z = false;
        if (this.mPresenters.isEmpty()) {
            return false;
        }
        if (fVar != null) {
            z = fVar.onSubMenuSelected(subMenuBuilder);
        }
        Iterator<WeakReference<C0218f>> it = this.mPresenters.iterator();
        while (it.hasNext()) {
            WeakReference next = it.next();
            C0218f fVar2 = (C0218f) next.get();
            if (fVar2 == null) {
                this.mPresenters.remove(next);
            } else if (!z) {
                z = fVar2.onSubMenuSelected(subMenuBuilder);
            }
        }
        return z;
    }
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i2, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i2 > 0) {
                ...
                this.mHeaderIcon = C8184a.C8187c.m16466b(context, i2);
    ...
    public void addMenuPresenter(C0218f fVar) {
        addMenuPresenter(fVar, this.mContext);
    }
        ...
        if (!this.mPresenters.isEmpty() && this.mExpandedItem == menuItemImpl) {
            ...
            while (it.hasNext()) {
                ...
                if (fVar == null) {
                    ...
                    z = fVar.collapseItemActionView(this, menuItemImpl);
                    if (z) {
                        break;
                    }
                }
    ...
    public boolean dispatchMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
        C0200a aVar = this.mCallback;
        return aVar != null && aVar.mo1310a(menuBuilder, menuItem);
    }
    ...
    public boolean expandItemActionView(MenuItemImpl menuItemImpl) {
        ...
        while (it.hasNext()) {
            ...
            if (fVar == null) {
                ...
                z = fVar.expandItemActionView(this, menuItemImpl);
                if (z) {
                    break;
                }
            }
    ...
    public boolean performItemAction(MenuItem menuItem, int i) {
        return performItemAction(menuItem, (C0218f) null, i);
    }
    ...
    public void removeMenuPresenter(C0218f fVar) {
        Iterator<WeakReference<C0218f>> it = this.mPresenters.iterator();
        while (it.hasNext()) {
            WeakReference next = it.next();
            C0218f fVar2 = (C0218f) next.get();
    ...
    public void setCallback(C0200a aVar) {
        this.mCallback = aVar;
    }
    ...
    public void addMenuPresenter(C0218f fVar, Context context) {
        this.mPresenters.add(new WeakReference(fVar));
    ...
    public boolean performItemAction(MenuItem menuItem, C0218f fVar, int i) {
        MenuItemImpl menuItemImpl = (MenuItemImpl) menuItem;
        if (menuItemImpl == null || !menuItemImpl.isEnabled()) {
            return false;
        }
        boolean invoke = menuItemImpl.invoke();
        C2277b supportActionProvider = menuItemImpl.getSupportActionProvider();
        boolean z = supportActionProvider != null && supportActionProvider.mo1956a();
        if (menuItemImpl.hasCollapsibleActionView()) {
            ...
            if (z) {
                supportActionProvider.mo1959f(subMenuBuilder);
            }
            invoke |= dispatchSubMenuSelected(subMenuBuilder, fVar);
            if (!invoke) {
                close(true);
            }
        } else if ((i & 1) == 0) {
